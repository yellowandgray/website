...
<!--                        <img src="images/c.png" alt="" title="" class="img-responsive" >
                    ...
                    <div class="abt-pos">
                        <div class="col-md-6 about-left text-justify wow fadeInUp">
                            <!--                            <h3 class="title">Alias Innovation Sdn Bhd</h3>-->
                            <!--                            <p class="about-bottom">Duis euismod massa ut sem fringilla blandit.</p>-->
                            <p>Alias Innovation is a leading technology and software solutions provider in Malaysia, with focused domain areas including Hospital Information Systems and Healthcare,  Asset Management,  Maintenance Management, E-Commerce among others.</p>
                            <br/>
<!--                            <p>Our differentiation lies in our mission to <strong class="color-blue">ENERGIZE, MONETIZE</strong> AND <strong class="color-blue">FUTURIZE</strong> the businesses of all clients.</p>-->
                            <!--                            <br/>-->
                            <p>Alias Innovation is also an established Hospital Information System provider in Malaysia with our own Medik@l brand.</p>
...
<!--                <h5>we offer products and services for your<span>personal</span> and<span>professional banking</span> needs.</h5>-->
                ...
                <!--                <div class="col-md-5 service-left-grid">
                               ...
                               <div class="col-md-7 text-center agileinfo-about-grid">
                                    ...
                                    <div class="col-md-4 col-xs-4 service-subgrids">
                                        <img src="images/commodity/003.jpg" alt="" title="" class="img-responsive">
                                                                <div class="w3ls-about-grid">
                                    ...
                                    <div class="col-md-4 col-xs-4 service-subgrids">
                                        <img src="images/commodity/004.jpg" alt="" title="" class="img-responsive">
                                                                <div class="w3ls-about-grid">
                                    ...
                                    <div class="col-md-4 col-xs-4 service-subgrids">
                                        <img src="images/commodity/006.jpg" alt="" title="" class="img-responsive">
                                                                <div class="w3ls-about-grid">
                    ...
                    <div class="col-md-4 man-grid">
                        ...
                        <!--                        <div class="man-grid2"><h5>Ensuring there's a high level of customer service.</h5></div>
                                                <p class="about-text-w3l">Pellentesque accumsan cursus dui, sodales blandit urna sodal vitaepel entesque accumsan cursus dui,sod
                                                    les blandit urna urna sodales vitae pellentesque accumsan cursus dui Maece placerat eget mi vitae
                                                    euismod. Du aliquam efficitur mi, et eleifend ye</p>
            ...
            <div class="container">
                    ...
                    <div class="padding-tb-20">
                        ...
                        <div class="address-grid">
                            ...
                            <ul class="social-icons3">
                                ...
                                <li>
                                    <a href="https://www.facebook.com/AliasInnovation/" class="s-iconfacebook">
                                        <span class="fa fa-facebook" aria-hidden="true"></span>
                                    </a>
                                </li>
                                <li>
                ...
                <div class="col-lg-6 col-md-6  contact-right-grid wow fadeInUp">
                    ...
                    <div class="agileits-main-right margin-b-20 wow fadeInUp">
                        <form class="contact agile_form" onsubmit="return submitForm('contact_form');" id="contact_form">
                            <div class="form-group">
                                <label class="header">Name</label>
                                <div class="icon1 w3ls-name1">
                                    <input placeholder=" " name="name" type="text" id="name" data-message="Enter name" data-emaillabel="Name" required class="mandatory field" />
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="icon2">
                                    <label class="header">Email</label>
                                    <input placeholder=" " name="email" type="email" id="email" data-message="Enter email" data-emaillabel="Email" required class="mandatory field" />
                                </div>
                            </div>
                            <div class="form-group">
