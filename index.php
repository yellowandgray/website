...
<html lang="en">
    ...
    <body class="top-header">
        ...
        <div class="main-navigation bg-primary header" id="mainmenu-area">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-2 logo-size">
                        <img src="assets/img/logo-01.png" alt="" class="img-fluid">
                    </div>
                    <div class="col-lg-10 col-md-10">
                        <nav class="navbar navbar-expand-lg navbar-dark  main-nav navbar-togglable">
...
<!--        <section class="banner-area py-7" id="banner">
             Content 
            <div class="container">
                ...
                <div class="row justy-content-center">
                    ...
                    <div class="col-lg-3 col-sm-6 col-md-6">
                        <div class="text-center feature-block">
                            ...
                            <h4 class="mb-2">Our Technology</h4>
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                        </div>
                    </div>
                ...
                <div class="row ">
                    ...
                    <div class="col-lg-6 pl-4">
                        <div class="service-content">
                            <h1>Technology and equipment selection according to waste characteristics</h1>
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-sm-6 col-md-6">
                        <div class="process-block">
                            <img src="assets/img/process/process-1.png" alt="" class="img-fluid">
                    ...
                    <div class="col-lg-4 col-sm-6 col-md-6">
                        <div class="process-block">
                            <img src="assets/img/process/process-3.png" alt="" class="img-fluid">
                    ...
                    <div class="col-lg-4 col-sm-6 col-md-6">
                        <div class="process-block">
                            <img src="assets/img/process/process-2.png" alt="" class="img-fluid">
