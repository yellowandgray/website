...
<html lang="zxx">
    ...
    <!-- Mirrored from keenitsolutions.com/products/html/edulearn/edulearn-demo/index5.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Mar 2019 06:04:45 GMT -->
    <!--head-->
    <?php
    include 'head.php';
    $page = 'home';
    ...
    <body class="home5">
                        ...
                        <div class="display-table">
                            <div class="display-table-cell">
                                <div class="container text-center">
                                    ...
                                    <a href="#" class="sl-get-started-btn" data-animation-in="lightSpeedIn" data-animation-out="animate-out">Read More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="display-table">
                            <div class="display-table-cell">
                                <div class="container text-center">
                                    ...
                                    <a href="#" class="sl-get-started-btn" data-animation-in="fadeInUp" data-animation-out="animate-out">Read More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row uppercase">
                    ...
                    <div class="col-md-4">
                        <div class="news-normal-block">
                            ...
                            <h4>AALUV Classroom Instructor</h4>
        ...
        <!--        <div id="rs-testimonial" class="rs-testimonial rs-testimonial-5 blue-bg bg8 sec-spacer">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div  class="rs-carousel owl-carousel" data-loop="true" data-items="1" data-margin="30" data-autoplay="true" data-autoplay-timeout="5000" data-smart-speed="1200" data-dots="true" data-nav="true" data-nav-speed="false" data-mobile-device="1" data-mobile-device-nav="true" data-mobile-device-dots="true" data-ipad-device="1" data-ipad-device-nav="true" data-ipad-device-dots="true" data-md-device="1" data-md-device-nav="true" data-md-device-dots="true">
    ...
    <!-- Mirrored from keenitsolutions.com/products/html/edulearn/edulearn-demo/index5.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Mar 2019 06:06:12 GMT -->
</html>
