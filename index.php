    ...
    <body class="no-page-top">
        ...
        <div id="container">
                    ...
                    <ul>
                        <li data-transition="fade" data-slotamount="7" data-masterspeed="600">
                            ...
                            <div class="tp-caption v-caption-big-white sfl stl" data-x="450" data-y="245" data-speed="600" data-start="600" data-easing="Power1.easeInOut" data-splitin="none" data-splitout="none" data-elementdelay="0" data-endelementdelay="0" data-endspeed="300">
                                Viva Odyssey designed and <br />developed a web-based solution
                            </div>
                            <div class="tp-caption v-caption-h1 sfl stl" data-x="450" data-y="360" data-speed="700" data-start="1200" data-easing="Power1.easeInOut" data-splitin="none" data-splitout="none" data-elementdelay="0" data-endelementdelay="0" data-endspeed="300">
                                Initially targeted to improve the Health,<br>
            ...
            <div class="v-page-wrap no-bottom-spacing">
                ...
                <div class="v-parallax v-bg-stylish  no-shadow" id="about">
                    <div class="container">
                        <div class="row center app-brief">
                            <div class="col-sm-12">
                                ...
                                <p class="text-justify">Viva Odyssey further extended its services to cater to the shortage of manpower and trainers for the industry that led toward recruitment and job placements.</p>
                                <p class="text-justify">Due to the demand of skilled personnel, Viva Odyssey in 2010 create a training division that conducts courses, safety training, workshops and leadership training to corporates and individuals. This lead towards the birth of “The Starfish Project” which is the social impact initiative and CSR efforts of Viva Odyssey.</p>
                            </div>
                        </div>
                    </div>
                    <div class="container">
                            ...
                            <div class="col-sm-4">
                                <div class="height-box-1 feature-box feature-box-secundary-one v-animation" data-animation="grow" data-delay="0">
                                    ...
                                    <div class="feature-box-text clearfix">
                                        ...
                                        <div class="feature-box-text-inner">
                                            <p>CONSULTANCY SERV-SAFETY</p>
                                            <p>CONSULTANCY SELF-OPERATED</p>
                                            <p>(APPROVAL DATE )16.03.17</br>(EXPIRY DATE) 15.03.2020</p>
                            ...
                            <div class="col-sm-4">
                                <div class="feature-box feature-box-secundary-one v-animation" data-animation="grow" data-delay="200">
                                    ...
                                    <div class="feature-box-text">
                                        ...
                                        <div class="feature-box-text-inner">
                                            <p>MANPOWER SUPPLY-LECTURING & TRAINING PERSONNEL</p>
                                            <p>SELF OPERATED</p>
                                            <p>(APPROVAL DATE) 07.04.2017</br>(EXPIRY DATE) 15.03.2020</p>
                                            <!--<a href="#" class="read-more">Read More</a>-->
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-4">
                                <div class="feature-box feature-box-secundary-one v-animation" data-animation="grow" data-delay="400">
                                    ...
                                    <div class="feature-box-text">
                                        ...
                                        <div class="feature-box-text-inner">
                                            <p>MANPOWER SUPPLY-HSE SPECIALIST</p>
                                            <p>SELF OPERATED</p>
                                            <p>(APPROVAL DATE) 05.06.2017</br>(EXPIRY DATE) 15.03.2020</p>
                                            <!--<a href="#" class="read-more">Read More</a>-->
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row app-brief">
                            <div class="col-sm-12">
                                ...
                                <a href="energy.php" class="read-more read">Read More</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row  v-counter-wrap v-animation" data-animation="grow" data-delay="200">
                            <div class="col-sm-4">
                                <div  class="box-2">
                                    ...
                                    <ul class="v-list-v2 ul-font-color">
