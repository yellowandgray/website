                        ...
                        <div class="bx-02  coach-box  wow fadeInUp">
                            ...
                            <div class="features_item  d-flex flex-column align-items-center ">
                                ...
                                <div class="text-center arrow-1">
                                    <a href="contact"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="text-bg wow fadeInUp">
                                <div class="about_text">
                                    ...
                                    <p><span>Learn. Earn. Prosper….That is what we do here. And that is what I absolutely want for you. </span></p>
                                    <p>A warm welcome! Thank you so much for your time. I am honored to have you here. I trust that the content you will find here will in someways enrich your life. If you feel you have read/ watched something here that you find may be valuable to someone you know, please just share it. That is my only goal - to bring <em class="bold">real knowledge to real people.</em></p>
                                    <ul class="list-1">
                                        ...
                                        <i class="fa fa-arrow-right" aria-hidden="true"></i><li>She has touched thousands of lives with her work and says the journey has only just begun. Her goal is to touch the lives of 1 million people in the next one year. Will you help her?</li>
                                    </ul>
                                </div>
                                        ...
                                        <div class="testimonials_content">
                                            <div class="test-v">
                                                ...
                                                <div class="button discover_button center">
                                                    <a href="testimonials" class="d-flex flex-row align-items-center justify-content-center">Read More</a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="testimonials_content">
                                            <div class="test-v">
                                                ...
                                                <video class=" video-res features_item box-3 d-flex flex-column align-items-center justify-content-end text-center" style="width: 100%" height="315" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen controls>
                                                    ...
                                                    Your browser does not support the <code>video</code> tag.
                                                </video> <div class="button discover_button center">
                                                    <a href="testimonials" class="d-flex flex-row align-items-center justify-content-center">Read More</a>
                                                </div>
                                                    ...
                                                    <div class="owl-carousel owl-theme testimonials_slider">
                                                        ...
                                                        <div class="owl-item-1 testimonials_item d-flex flex-column align-items-center justify-content-center text-center">
                                                            <div class="testimonials_content">
                                                                ...
                                                                <div class="button discover_button center">
                                                                    <a href="testimonials" class="d-flex flex-row align-items-center justify-content-center">Read More<img src="images/arrow_right.svg" alt=""></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="owl-item-1 testimonials_item d-flex flex-column align-items-center justify-content-center text-center">
