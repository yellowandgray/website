...
<html>
    ...
    <body>
                ...
                <div class="inner_sec_info_wthree_agile">
                    <div class="help_full">
                        ...
                        <div class="col-md-6 banner_bottom_grid help">
                            ...
                            <div class="video-1">
                                <iframe width="100%" height="300px" src="https://www.youtube.com/embed/S7wCAquf9Us" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </div>
                        </div>
        ...
        <!--//ab-->
        <!--/what-->
        <div class="works" style="background-image: url(images/background.jpg)!important;">
            <div class="container">
                <div class="col-md-4 banner_bottom_left  text-center">
                    <div class="banner_bottom_pos">
                        <div class="banner_bottom_pos_grid">
                            <div class="col-xs-12 banner_bottom_grid_left">
        ...
        <!--/banner_bottom-->
        <div class="banner_bottom">
            <h3 class="tittle-w3ls we">Latest Posts</h3>
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <img src='images/g9.jpg' alt="">
                        <p>Lorem ipsum dolor sit amet, do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                    </div>
                    <div class="col-md-4">
                        <img src='images/g9.jpg' alt="">
                        <p>Lorem ipsum dolor sit amet, do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                ...
                <div class="row pad-100">
                    <h2 class="tittle-w3ls we text-center pad-20"><strong>we have something</strong></h2>
                    <h3 class="tittle-w3ls we">FOR EVERY ENTREPRENEUR</h3>
                    <p class="text-center">Whether you’re just getting started with the laptop lifestyle, or trying to grow your monthly income to 5 figures and beyond, we have resources designed to help.</p>
                    <div class="ab_button text-center">
                        <a class="btn btn-primary btn-lg hvr-underline-from-left" href="single.html" role="button">GET STARTED</a>
                    </div>
                </div>
                <div class="row">
                    <h3 class="tittle-w3ls we">Latest Podcasts</h3>
                    <div class="col-md-4">
                        <img src='images/g9.jpg' alt="">
                        <p>Lorem ipsum dolor sit amet, do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                    </div>
        ...
        <div class="footer">
            <div class="footer_inner_info_w3ls_agileits">
                ...
                <div class="clearfix"></div>
                <p class="copy-right">&copy 2019 All rights reserved | Design by <a href="http://www.yellowandgray.com/ " target="blank">YG STUDIO</a></p>
            </div>
        </div>
    </div>
    <!-- //footer -->
