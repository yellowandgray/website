    ...
    <body data-spy="scroll" data-target=".header" data-offset="50">
        ...
        <section class="ptb-90" style="background: url(assets/img/chart-bg.jpg)no-repeat;">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <img src="assets/img/connecting-chart.png" alt="connecting Chart" style="width: 100%"/>
                    </div>
                </div>
            </div>
        </section>
                            ...
                            <div class="slide">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 margin-buttom-20">
                                        <img src="assets/img/slider/001.png" alt="slider-1">
                                    </div>
                                </div>
                            </div>
                            <div class="slide">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 margin-buttom-20">
                                        <img src="assets/img/slider/002.png" alt="slider-2">
                                    </div>
                                </div>
                            </div>
                            <div class="slide">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 margin-buttom-20">
                                        <img src="assets/img/slider/003.png" alt="slider-3">
                                    </div>
                                </div>
                            </div>
                            <div class="slide">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 margin-buttom-20">
                                        <img src="assets/img/slider/004.png" alt="slider-4">
                                    </div>
                                </div>
                            </div>
                            <div class="slide">
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <img src="assets/img/slider/005.png" alt="slider-5">
                                    </div>
                                </div>
                            </div>
                            <div class="slide">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 margin-buttom-20">
                                        <img src="assets/img/slider/006.png" alt="slider-6">
                                    </div>
                                </div>
                            </div>
                            <div class="slide">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 margin-buttom-20">
                                        <img src="assets/img/slider/007.png" alt="slider-7">
                                    </div>
                                </div>
                            </div>
                            <div class="slide">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 margin-buttom-20">
                                        <img src="assets/img/slider/008.png" alt="slider-8">
                                    </div>
                                </div>
                            </div>
                            <div class="slide">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 margin-buttom-20">
                                        <img src="assets/img/slider/009.png" alt="slider-9">
                                    </div>
                                </div>
                            </div>
                            <div class="slide">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 margin-buttom-20">
                                        <img src="assets/img/slider/010.png" alt="slider-10">
                                    </div>
                                </div>
                            </div>
                            <div class="slide">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 margin-buttom-20">
                                        <img src="assets/img/slider/011.png" alt="slider-11">
                                    </div>
                                </div>
                            </div>
                            <div class="slide">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 margin-buttom-20">
                                        <img src="assets/img/slider/012.png" alt="slider-12">
                                    </div>
                                </div>
                            </div>
                            <div class="slide">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 margin-buttom-20">
                                        <img src="assets/img/slider/013.png" alt="slider-13">
                                    </div>
                                </div>
                            </div>
                            <div class="slide">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 margin-buttom-20">
                                        <img src="assets/img/slider/014.png" alt="slider-14">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row flexbox-center">
                    <div class="col-lg-3">
                        <div class="single-feature-box text-lg-right text-center">
                            <ul>
                                <li>
                                    <div class="feature-box-info pop" data-toggle="popover" title="Christian News" data-container="body" data-placement="left" data-html="true" data-content="<ul><i class='icofont icofont-ui-check'></i> <li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; International christian headlines</li><i class='icofont icofont-ui-check'></i><li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; National</li><i class='icofont icofont-ui-check'></i><li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; From the holy land</li><i class='icofont icofont-ui-check'></i><li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Church news</li><i class='icofont icofont-ui-check'></i><li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Trending christian viral videos – music - testimonies etc..</li></ul>">
                                        <h4>Christian News</h4>
                                    </div>
                                ...
                                <li>
                                    <div class="feature-box-info pop" data-toggle="popover" data-container="body" data-placement="left" title="Member Log in to Local Church" data-html="true" data-content="<ul><i class='icofont icofont-ui-check'></i> <li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Log in to the local church page with your unique member ID and password</li></ul>">
                                        <h4>Member log in to Local Church</h4>
                                    </div>
                                    <div class="feature-box-icon">
                                ...
                                <li>
                                    <div class="feature-box-info pop" data-toggle="popover" data-container="body" data-placement="left" title="Member Posts" data-html="true" data-content="<ul><i class='icofont icofont-ui-check'></i><li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Directory of all church members with the details of their family members which is updated regularly – yearly</li><i class='icofont icofont-ui-check'></i><li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Social profile with a spiritual aspect of each member</li><i class='icofont icofont-ui-check'></i><li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Request for prayer</li><i class='icofont icofont-ui-check'></i><li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Sharing personal testimony</li><i class='icofont icofont-ui-check'></i><li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Sharing special word from god</li><i class='icofont icofont-ui-check'></i><li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Sharing a special personal News</li><i class='icofont icofont-ui-check'></i><li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Other</li></ul>">
                                        <h4>Member Posts</h4>
                                    </div>
                                    <div class="feature-box-icon">
                                        <i class="icofont icofont-newspaper"></i>
                    ...
                    <div class="col-lg-6">
                        <div class="single-feature-box text-center">
                            <section class="customer-logos1 slider">
                                <div class="slide"><img src="assets/img/slider/001.png" alt="slider-1"></div>
                                <div class="slide"><img src="assets/img/slider/002.png" alt="slider-2"></div>
                                <div class="slide"><img src="assets/img/slider/003.png" alt="slider-3"></div>
                                <div class="slide"><img src="assets/img/slider/004.png" alt="slider-4"></div>
                                <div class="slide"><img src="assets/img/slider/005.png" alt="slider-5"></div>
                            </section>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="single-feature-box text-lg-left text-center">
                            <ul>
                                <li>
                                    ...
                                    <div class="feature-box-info pop" data-toggle="popover" data-container="body" data-placement="right" title="Pay" data-html="true" data-content="<p>Link from the specific project will be directed here to a payment gateway</p><p>List of the projects that need financial support</p><p>Options to pay</p><ul><i class='icofont icofont-ui-check'></i><li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Tithe</li><i class='icofont icofont-ui-check'></i><li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Offerings – thanksgiving etc</li><i class='icofont icofont-ui-check'></i><li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Alms – charity </li><i class='icofont icofont-ui-check'></i><li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Other donations</li></ul>">
                                        <h4>Pay</h4>
                                    </div>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <div class="feature-box-info pop" data-toggle="popover" data-container="body" data-placement="right" title="Live" data-html="true" data-content="<ul><i class='icofont icofont-ui-check'></i><li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Live church services</li><i class='icofont icofont-ui-check'></i><li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Live church programmes like concerts, conventions, workshops etc</li><i class='icofont icofont-ui-check'></i><li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Live online offerings – during church services</li></ul>">
                                        <h4>Live</h4>
                                    </div>
                                </li>
                                <li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="screenshot-wrap">
                            ...
                            <div class="single-screenshot">
                                <img src="assets/img/screenshot/screenshot6.jpg" alt="screenshot" />
                            </div>
                            <div class="single-screenshot">
                                <img src="assets/img/screenshot/screenshot7.jpg" alt="screenshot" />
                            </div>
                            <div class="single-screenshot">
                                <img src="assets/img/screenshot/screenshot8.jpg" alt="screenshot" />
                            </div>
                            <div class="single-screenshot">
                                <img src="assets/img/screenshot/screenshot9.jpg" alt="screenshot" />
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="hero-area" id="church-home">
            <div class="container">
                <div class="row">
                    <div class="col-lg-7">
                        <div class="hero-area-content">
                            <h1>Churchlink</h1>
                            <p>A web application to equip and empower church authorities like the pastors and the church administration to effectively utilise the latest IT tools and technologies in church management system.</p>
                            <!--                            <a href="#" class="appao-btn">Google Play</a>
                                                        <a href="#" class="appao-btn">App Store</a>-->
                        </div>
                    </div>
        ...
        <section class="about-area ptb-90">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="sec-title">
                            <h2>About Churchlink<span class="sec-title-border"><span></span><span></span><span></span></span></h2>
                            <p>A web application to equip and empower church authorities like the pastors and the church administration to effectively utilise the latest IT tools and technologies in church management system.</p>
                        </div>
                    </div>
                </div>
        ...
        <!-- feature section start -->
        <section class="feature-area ptb-90" id="church-feature">
            <div class="container">
                <div class="sec-title">
                    <h2>Web App Features<span class="sec-title-border"><span></span><span></span><span></span></span></h2>
                    <p>A web application to equip and empower church authorities like the pastors and the church administration to effectively utilise the latest IT tools and technologies in church management system.</p>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <section class="customer-logos slider">
                            <div class="slide">
                                <div class="row">
                                    <div class="col-md-6 padding-top-40 margin-buttom-20">
                                        <h4>Manage Churchlink App</h4>
                                        <br/>
                                        <ul class="text-left">
                                            <i class='icofont icofont-ui-check'></i><li> &nbsp; Manage Members and administration </li>
                                            <i class='icofont icofont-ui-check'></i><li> &nbsp; Manage Mobile App Content</li>
                                            <i class='icofont icofont-ui-check'></i><li> &nbsp; Manage News & Events</li>
                                            <i class='icofont icofont-ui-check'></i><li> &nbsp; Manage and Church Member Data</li>
                                        </ul>
                                    </div>
                                    <div class="col-md-6 margin-buttom-20">
                                        <img src="assets/img/church-slider/001.png" alt="slider-1">
                                    </div>
                                </div>
                            </div>
                            <div class="slide">
                                <div class="row">
                                    <div class="col-md-6 padding-top-40 margin-buttom-20">
                                        <h4>Auto Triggers/Reminders for</h4>
                                        <br/>
                                        <ul class="text-left">
                                            <i class='icofont icofont-ui-check'></i><li> &nbsp; Baptized Today (30/60/90 Days Follow-up Phone Call)</li>
                                            <i class='icofont icofont-ui-check'></i><li> &nbsp; New Members Follow-up (30 days Phone Call)</li>
                                            <i class='icofont icofont-ui-check'></i><li> &nbsp; Birthday Day/Anniversary Day</li>
                                            <i class='icofont icofont-ui-check'></i><li> &nbsp; Prayer Request – Follow-up (post-surgery/emergency etc)</li>
                                        </ul>
                                    </div>
                                    <div class="col-md-6">
                                        <img src="assets/img/church-slider/002.png" alt="slider-2">
                                    </div>
                                </div>
                            </div>
                            <div class="slide">
                                <div class="row">
                                    <div class="col-md-6 padding-top-40 margin-buttom-20">
                                        <h4>House Visiting Testimony</h4>
                                        <br/>
                                        <ul class="text-left">
                                            <i class='icofont icofont-ui-check'></i><li> &nbsp; Location based visit via Pastor’s App – Tracking</li>
                                        </ul>
                                    </div>
                                    <div class="col-md-6 margin-buttom-20">
                                        <img src="assets/img/church-slider/003.png" alt="slider-3">
                                    </div>
                                </div>
                            </div>
                            <div class="slide">
                                <div class="row">
                                    <div class="col-md-6 padding-top-40 margin-buttom-20">
                                        <h4>Report Generations</h4>
                                        <br/>
                                        <ul class="text-left">
                                            <i class='icofont icofont-ui-check'></i><li> &nbsp; Details of past 6 visits</li>
                                            <i class='icofont icofont-ui-check'></i><li> &nbsp; Age wise reports</li>
                                            <i class='icofont icofont-ui-check'></i><li> &nbsp; Family Tree report</li>
                                            <i class='icofont icofont-ui-check'></i><li> &nbsp; Sunday School Selection by Age group</li>
                                        </ul>
                                    </div>
                                    <div class="col-md-6 margin-buttom-20">
                                        <img src="assets/img/church-slider/004.png" alt="slider-4">
                                    </div>
                                </div>
                            </div>
                            <div class="slide">
                                <div class="row">
                                    <div class="col-md-6 padding-top-40 margin-buttom-20">
                                        ...
                                        <br/>
                                        <ul class="text-left">
                                            <i class='icofont icofont-ui-check'></i><li> &nbsp; Profession (organization/position/tiltle/company)</li>
                                            <i class='icofont icofont-ui-check'></i><li> &nbsp; Member since</li>
                                            <i class='icofont icofont-ui-check'></i><li> &nbsp; Previous Church</li>
                                            <i class='icofont icofont-ui-check'></i><li> &nbsp; Education</li>
                                            <i class='icofont icofont-ui-check'></i><li> &nbsp; Talents and Abilities</li>
                                        </ul>
                                    </div>
                                    <div class="col-md-6 margin-buttom-20">
                                        <img src="assets/img/church-slider/005.png" alt="slider-5">
                                    </div>
                                </div>
                            </div>
                        </section>
        ...
        <section class="team-area ptb-90" id="team">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="sec-title">
                            <h2>Leadership Team<span class="sec-title-border"><span></span><span></span><span></span></span></h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="single-team-member" id="inline-popups">
                            <div class="team-member-img">
...
<!--                                            <a href="#"><i class="icofont icofont-social-facebook"></i></a>
                            ...
                            <div class="team-member-info">
                                <a href="#test-popup" data-effect="mfp-zoom-in"><h4>Joshua Clements</h4></a>
                                <p>Founder & CEO</p>
                            </div>
                        </div>
                    </div>
...
<!--                                            <br/>
        ...
        <div id="test-popup" class="white-popup mfp-with-anim mfp-hide">
            ...
            <br/>
            <p style="text-align: justify">The concept and design of the Christlink App was  birthed out of a deep desire to serve God and help the Church and bring together the global community of Christians. <br/>Joshua Clements a post graduate in Business Administration from Chrarles Sturt University,  has over 25 years in the corporate world as an expert in Human Resource, business networking and People Management. Combining his passion for God and his God given ability to work for the people of God he was driven to convert his vision into a blessed reality</p>
        </div>
        <div id="popup-test" class="white-popup mfp-with-anim mfp-hide">
            ...
            <br/>
            <p style="text-align: justify">He comes with two decades of experience in Music production and Media. He has created and produced numerous music albums, music videos, concerts and more for popular musicians across genres. He also serves as a Media Consultant and Board Member of many illustrious organisations, and has successfully charted a growth trajectory in all areas of his portfolio of Brand, Media, Sales and Music.<br/><br/> He is also well-versed in the art of photography and cinematography, culminating in hit music videos. A musician himself, with in-depth knowledge of varied musical instruments and the art of creation of music and production, he knows and understands the many facets of industry making him an asset to the Company.</p>
        </div>
        ...
        <script>
            $(document).ready(function () {
                $('.customer-logos').slick({
                    ...
                    dots: false,
                    pauseOnHover: false,
                    nextArrow: '<img class="slick-prev" src="assets/img/right-arrow.png">',
                    prevArrow: '<img class="slick-next" src="assets/img/left-arrow.png">',
                    responsive: [{
                            breakpoint: 768,
                            settings: {
                                slidesToShow: 1
