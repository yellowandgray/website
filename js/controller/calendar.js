app.controller('CalendarController', function ($scope, $rootScope, $http, handset, apiPath, predefined, userDetail) {
    ...
    $scope.getData = function () {
        ...
        handset.showSpinner();
        $http.get(apiPath.url + 'get_franchise_calendar/' + userDetail.get('eshine_ID')).then(function (response) {
            handset.hideSpinner();
