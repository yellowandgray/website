...
<html>
    <head>
        ...
        <link href="//daneden.github.io/animate.css/animate.min.css" type="text/css"/>
    ...
    <body>
        ...
        <section class="ptb50">
            <div class="container">
                <div class="row" style="background: url(img/bg/service-banner-bg-1.png)no-repeat;padding: 20px 0px;">
                    <div class="col-md-12">
                        <div class="service-section wow fadeInDown">
                            <h1>EMPOWERING KNOWLEDGE</h1>
                        </div>
                        <div class="services-text">
                            <h2>BE WITH THE <br/>RIGHT <br/> PARTNERS. </h2>
                        </div>
                        <div class="service-1-h4">
                            <h4>You need experts you can always turn to for<br/> quidance. And that's what we're about.</h4>
                        </div>
                    </div>
                </div>
                <div class="row" style="background: url(img/bg/service-banner-bg-3.png)no-repeat;padding: 50px 0px;">
                    <div class="col-md-2">
                        <div id="circle">
        ...
        <section class="ptb50" style="background: #eee;">
            <div class="container">
                <h1 class="text-center">SERVICES</h1>
                <div class="row" style="background: url(img/bg/service-banner-bg-2.png)no-repeat;padding: 20px 0;">
                    <div class="col-md-10">
                        <div class="empowering-text">
                            <p>BITE SIZED TRAINING</p>
                            <p>FULL SIZED TRAINING</p>
                    ...
                    <div class="col-md-2">
                        <div id="circle">
                            <svg style="top: 30%;right: 0;width: auto;" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="300px" height="300px" viewBox="0 0 300 300" enable-background="new 0 0 300 300" xml:space="preserve">
                            <defs>
                            <path id="circlePath" d="M 150, 150 m -60, 0 a 60,60 0 0,1 120,0 a 60,60 0 0,1 -120,0 "/>
                            </defs>
                            <circle cx="150" cy="100" r="75" fill="none"/>
                ...
                <div class="row" style="background: url(img/bg/service-banner-bg-4.png)no-repeat;padding: 20px 0 40px;">
                    <div class="col-md-2">
                        <div id="circle">
        ...
        <section class="ptb50" style="background: url(img/bg/upcoming-tranining-bg.png)no-repeat;padding: 70px 0 40px;">
            <div class="container">
                <h1 class="text-center" style='padding: 0 0 60px 0;margin-top: -40px;'>Upcoming Trainings</h1>
                <div class="row">
                    <div class="col-md-3">
