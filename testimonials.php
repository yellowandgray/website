<!DOCTYPE html>
<html lang="en">
        <?php include 'head.php'; $page = 'testimonials'; ?>
    <body>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 offset-lg-3 text-center section_title section_title_dark">
                            <h2>HEAR IT FROM THE HAPPY HORSE’S MOUTH</h2>
                        </div>
                    </div>
                    <div class="row pad-20">
                        <div class="col-lg-8 left-order testimoni">
                    ...
                    <div class="row pad-20">
                        <div class="col-lg-8 left-order testimoni">
                            ...
                            <em>Reach Avil Pinto at https://www.facebook.com/groups/Dubaijobhunt/</em>
                        </div>
                        <div class="col-lg-4 box-7 text-center">
                    ...
                    <div class="row pad-20">
                        <div class="col-lg-8 left-order testimoni">
                            <h4><strong>Neena Sharma</strong></h4>
                    ...
                    <div class="row pad-20">
                        <div class="col-lg-8 left-order testimoni">
                            <h4><strong>Naman Rajvanshi</strong></h4>
                    ...
                    <div class="row pad-20">
                        <div class="col-lg-8 left-order testimoni">
                            <h4><strong>Stefania Picheca</strong></h4>
                    ...
                    <div class="row pad-20">
                        <div class="col-lg-8 left-order testimoni">
                            <h4><strong>Karim Zayed</strong></h4>
                    ...
                    <div class="row pad-20">
                        <div class="col-lg-8 left-order testimoni">
                            <h4><strong>Luma Iqbal</strong></h4>
                    ...
                    <div class="row pad-20">
                        <div class="col-lg-8 left-order testimoni">
                            <h4><strong>Fanika Nikic</strong></h4>
