...
<html lang="zxx">
    ...
    <body class="inner-page">
        ...
        <?php include 'menu-5.php'; ?>
        <!--Full width header End-->

        <!-- Breadcrumbs Start -->
        <div class="rs-breadcrumbs bg7 breadcrumbs-overlay" style="background-image: url(images/sub-banner/sub-02.jpg) !important;">
                ...
                <div class="row uppercase wow fadeInUp">
                    ...
                    <div class="col-md-6">
                        <div  class="news-normal-block">
                            <img src="images/gallery/aaluv-robotics-020.jpg" alt=""/>
                        </div>
                    </div>
                </div>
                <div class="row uppercase wow fadeInUp col-6-align">
                    <div class="col-md-12">
        ...
        <section class="about-section padding-100 bg-section">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 padding-30 wow fadeInUp">
                        <div class="box-radius-bg-60">
                            <h4>SYLLABUS</h4>
                            <ul class="list-style-none color-white list-align">
        ...
        <section class="about-section padding-b-100">
            <div class="gallery-bg">
                <div class="container">
                    <h3 class="color-white text-center text">Robotic Devices made using LEGO EV3</h3>
