...
<html lang="en">
    ...
    <body class="no-skin" onload="listevents();">
                ...
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        <div class="page-header">
                            <h1>Events<small><i class="ace-icon fa fa-angle-double-right"></i></small></h1>
                        </div><!-- /.page-header -->
                        <div class="row">
                            <div class="col-xs-12">
                                <!-- PAGE CONTENT BEGINS -->
                                <div class="row">
                                    ...
                                    <form class="form-horizontal" id="add_event">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="bannertitle">Title : </label>

                                            <div class="col-sm-9">
                                                <input type="text" id="eventtitle" name="eventtitle" placeholder="Title" class="col-xs-10 col-sm-5">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="bannertitle">Date : </label>

                                            <div class="col-sm-9">
                                                <input type="text" id="eventdate" name="eventdate" placeholder="Date" class="col-xs-10 col-sm-5">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="homebanner">Banner Image : </label>

                                            <div class="col-sm-9">
                                                <input type="file" id="eventimage" name="eventimage" placeholder="Event Image" class="col-xs-10 col-sm-5">
                                            </div>
                                        </div>
