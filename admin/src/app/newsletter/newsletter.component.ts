...
export class NewsletterComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    getNewsletter(): void {
     this.httpClient.get<any>('http://ghmindia.com/api/v1/get_newsletter')
     .subscribe(
             (res)=>{
...
export class NewsletterDelete {
  ...
  confirmDelete() {
      ...
      this.loading = true;
      this.httpClient.get('http://ghmindia.com/api/v1/delete_record/newsletter/newsletter_id='+this.newsletter_id).subscribe(
          (res)=>{
                this.loading = false;
