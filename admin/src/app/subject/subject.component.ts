...
export class SubjectComponent implements OnInit {
  ...
  getsubject(ev): void {
    ...
    this.httpClient
      .get<any>("http://localhost/microview/mekana/api/v1/get_subject_by_language/"+this.language[ev.index].language_id)
      .subscribe(
        res => {
...
export class SubjectForm {
  ...
  constructor(
    ...
    this.httpClient
      .get("http://localhost/microview/mekana/api/v1/get_language")
      .subscribe(
        res => {
...
export class SubjectDelete {
  ...
  confirmDelete() {
    ...
    this.httpClient
      .get(
        "http://localhost/microview/mekana/api/v1/delete_record/subject/subject_id=" +
          this.subject_id
      )
      .subscribe(
        res => {
