...
export class OrderComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    getOrder(): void {
     this.httpClient.get<any>('http://localhost/microview/fresche/api/v1/get_order')
     .subscribe(
             (res)=>{
...
export class OrderDelete {
  ...
  confirmDelete() {
      ...
      this.loading = true;
      this.httpClient.get('http://localhost/microview/fresche/api/v1/delete_record/orders/orders_id='+this.orders_id).subscribe(
          (res)=>{
                this.loading = false;
