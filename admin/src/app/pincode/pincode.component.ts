...
export class PincodeComponent implements OnInit {
  ...
  getPincode(): void {
    this.httpClient
      .get<any>("http://localhost/project/three-levan/api/v1/get_delivery_pincode")
      .subscribe(
        res => {
...
export class PincodeDelete {
  ...
  confirmDelete() {
    ...
    this.httpClient
      .get(
        "http://localhost/project/three-levan/api/v1/delete_record/delivery_pincode/delivery_pincode_id=" + this.delivery_pincode_id
      )
      .subscribe(
        res => {
          this.loading = false;
