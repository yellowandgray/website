...
export class QuestionComponent implements OnInit {
    ...
    getQuestion(): void {
        this.httpClient.get<any>('http://localhost/project/mekana_new/api/v1/get_question')
        .subscribe(
                (res)=>{
...
export class QuestionForm {
    ...
    onSubmit() {
        ...
        var url = '';
          ...
          formData.append('sub_topic', this.questionForm.value.sub_topic);
