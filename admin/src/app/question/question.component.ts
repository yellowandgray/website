...
filter_question = 'null';
   ...
   getChapter(): void {
        this.chapter = [];
        this.httpClient.get<any>('http://localhost/mushak/feringo/api/v1/get_chapter_by_subject/'+this.selected_subject)
        .subscribe(
                (res)=>{
...
getTopic(): void {
this.topic = [];
        this.httpClient.get<any>('http://localhost/mushak/feringo/api/v1/get_topic_by_chapter/'+this.selected_chapter)
        .subscribe(
                (res)=>{
...
this.filter_text = this.searchTerm;
        ...
        this.httpClient.get<any>('http://localhost/mushak/feringo/api/v1/get_question_by_topic/'+this.selected_topic+'/'+this.selected_chapter+'/'+this.filter_text+'/'+this.filter_question)
        .subscribe(
                (res)=>{
...
fileProgress(fileInput: any) {
        ...
        this.httpClient.post('http://localhost/mushak/feringo/api/v1/import_question', formData).subscribe(
            (res) => {
                this.loading = false;
