...
export class QuestionComponent implements OnInit {
    ...
    getQuestion(): void {
        if (this.selected_chapter && this.selected_chapter != 0 && this.selected_topic) {
            ...
            this.httpClient.get<any>('http://localhost/microview/feringo/api/v1/get_question_by_topic/' + this.selected_topic + '/' + this.selected_chapter + '/' + this.filter_text + '/' + this.filter_question + '/' + this.selected_level)
                .subscribe(
                    (res) => {
