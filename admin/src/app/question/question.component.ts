...
export class QuestionComponent implements OnInit {
 ...
 getLanguageInit(): void {
    this.httpClient
      .get<any>("http://localhost/project/exam-horse-sample/api/v1/get_language")
      .subscribe(
        res => {
  ...
  getYearByLanguage(): void {
    ...
    this.httpClient
      .get<any>(
        "http://localhost/project/exam-horse-sample/api/v1/get_year_by_language/" +
  ...
  getSubjectByLanguage(): void {
    ...
    this.httpClient
      .get<any>(
        "http://localhost/project/exam-horse-sample/api/v1/get_subject_by_language/" +
          this.selected_language         
      )
      .subscribe(
        res => {
  ...
  getSubjectByYearnLanguage(): void {
    ...
    this.httpClient
      .get<any>(
        "http://localhost/project/exam-horse-sample/api/v1/get_subject_by_language_n_year/" +
          this.selected_language +
          "/" +
          this.selected_year
      )
   ...
   this.questionloader = true;
    this.httpClient
      .get<any>(
        "http://localhost/project/exam-horse-sample/api/v1/get_question_by_year_n_lang_n_subj/"+lid+"/"+sel_year+"/"+subj
      )
      .subscribe(
        res => {
   ...
   getQuestionsByYearAndLang(): void {
    ...
    this.httpClient
      .get<any>(
        "http://localhost/project/exam-horse-sample/api/v1/get_question_by_year_n_lang/"+lid+"/"+sel_year
      )
      .subscribe(
        res => {
          this.question = res["result"]["data"];
  ...
  getTopicBySubject(): void {
    ...
    this.httpClient
      .get<any>(
        "http://localhost/project/exam-horse-sample/api/v1/get_topic_by_subject_n_year/" +
  ...
  getQuestionsByTopicYear(): void {
    ...
    this.httpClient
      .get<any>(
            ...
            "http://localhost/project/exam-horse-sample/api/v1/get_question_by_topic_and_year/" +
              tid +
              "/" +
              sel_year
  ...
  getQuestionsByTopic(ev): void {
    ...
    this.httpClient
      .get<any>(
        "http://localhost/project/exam-horse-sample/api/v1/get_question_by_topic_n_year/" +
          tid
      )
      .subscribe(
        res => {
  ...
  getTopicByLngNYear(ev): void {
    ...
    this.httpClient
      .get<any>(
        "http://localhost/project/exam-horse-sample/api/v1/get_topic_by_lng_year/" +
          this.selected_language +
          "/" +
...
this.httpClient
      .get<any>(
        "http://localhost/project/exam-horse-sample/api/v1/get_question_by_year_n_otherlang/"+lid+"/"+sel_year
      )
      .subscribe(
        res => {
...
else
{
  ...
  fileProgress(fileInput: any) {
    ...
    this.httpClient
      .post(
        "http://localhost/project/exam-horse-sample/api/v1/import_question",
        formData
      )
      .subscribe(
        res => {
...
export class QuestionForm {
  ...
  constructor(
    ...
    this.httpClient
      .get("http://localhost/project/exam-horse-sample/api/v1/get_language")
      .subscribe(
        res => {
    ...
    if(this.data) {  
    this.httpClient
      .get("http://localhost/project/exam-horse-sample/api/v1/get_subject_by_language/"+this.data.language_id)
      .subscribe(
        res => {
          if (res["result"]["error"] === false) {
            this.subject = res["result"]["data"];
    ...
    if(this.data) {       
     ...
     this.httpClient
            .get("http://localhost/project/exam-horse-sample/api/v1/get_topic_details/"+this.data.topic_id)
            .subscribe(
              res => {
                if (res["result"]["error"] === false) {
                    ...
                    this.httpClient
                  .get("http://localhost/project/exam-horse-sample/api/v1/get_topic_by_subject/"+this.data.subject_id)
                   .subscribe(
                    res => {
                      if (res["result"]["error"] === false) {
                        this.topic = res["result"]["data"];
    ...
    this.httpClient
      .get("http://localhost/project/exam-horse-sample/api/v1/get_year")
      .subscribe(
        res => {
          if (res["result"]["error"] === false) {
            this.year = res["result"]["data"];
    ...
    this.httpClient
      .get<any>("http://localhost/project/exam-horse-sample/api/v1/get_book")
      .subscribe(
        res => {
  ...
  getTopicBySelSubjectEdit(ev): void {
   this.topic = [];
    ...
    var subj = ev.value;   
        this.httpClient
          .get<any>(
            "http://localhost/project/exam-horse-sample/api/v1/get_topic_by_subject/" +
              subj
          )
          .subscribe(
            res => {
  ...
  onSubmit() {
    ...
    this.httpClient
      .post("http://localhost/project/exam-horse-sample/api/v1/" + url, formData)
      .subscribe(
        res => {
          this.loading = false;
          if (res["result"]["error"] === false) {
  ...
  fileProgress(fileInput: any, name: string, path: string) {
    ...
    formData.append("file", fileData);
    this.httpClient
      .post("http://localhost/project/exam-horse-sample/api/v1/upload_file", formData)
      .subscribe(
        res => {
          this.loading = false;
          if (res["result"]["error"] === false) {
...
export class QuestionDelete {
  ...
  confirmDelete() {
    ...
    this.httpClient
      .get(
        "http://localhost/project/exam-horse-sample/api/v1/delete_record/question/question_id=" +
          this.question_id
      )
      .subscribe(
        res => {
