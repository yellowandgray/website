...
export class TopicComponent implements OnInit {
  ...
  getTopic(ev): void {
    ...
    if (typeof this.chapter[ev.index] !== 'undefined') {
      this.httpClient.get<any>('http://localhost/microview/fresche/api/v1/get_topic_by_chapter/' + this.chapter[ev.index].chapter_id)
        .subscribe(
          (res) => {
...
export class TopicForm {
  ...
  getChapter(): void {
    ...
    if (this.course == 1) {
      ...
      this.httpClient.get<any>('http://localhost/microview/fresche/api/v1/get_chapter_by_subject/' + this.topicForm.value.subject_id)
        .subscribe(
          (res) => {
            this.chapter = res["result"]["data"];
          },
      ...
      this.httpClient.get<any>('http://localhost/microview/fresche/api/v1/get_book_by_subject/' + this.topicForm.value.subject_id)
        .subscribe(
          (res) => {
            this.book = res["result"]["data"];
          },
  ...
  getChapterByBook(): void {
    this.httpClient.get<any>('http://localhost/microview/fresche/api/v1/get_chapter_by_book/' + this.topicForm.value.book_id)
      .subscribe(
        (res) => {
          this.chapter = res["result"]["data"];
        },
...
export class TopicDelete {
  ...
  confirmDelete() {
    ...
    this.loading = true;
    this.httpClient.get('http://localhost/microview/fresche/api/v1/delete_record/topic/topic_id=' + this.topic_id).subscribe(
      (res) => {
        this.loading = false;
        if (res["result"]["error"] === false) {
          this.dialogRef.close(true);
