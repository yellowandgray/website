...
export class TopicComponent implements OnInit {
    ...
    getsubject(): void {
    this.httpClient.get<any>('http://localhost/project/exam-horse-sample/api/v1/get_subject')
      .subscribe(
        (res) => {
    ...
    gettopic(ev): void {
        ...
        this.httpClient.get<any>('http://localhost/project/exam-horse-sample/api/v1/get_topic_by_subject/'+this.subject[ev.index].subject_id)
        .subscribe(
                (res)=>{
...
export class TopicForm {
    ...
    private httpClient: HttpClient) {
        ...
        this.httpClient.get('http://localhost/project/exam-horse-sample/api/v1/get_subject').subscribe(
            (res) => {
...
export class TopicDelete {
  ...
  confirmDelete() {
      ...
      this.loading = true;
      this.httpClient.get('http://localhost/project/exam-horse-sample/api/v1/delete_record/topic/topic_id='+this.topic_id).subscribe(
          (res)=>{
                this.loading = false;
                if(res["result"]["error"] === false) {
                    this.dialogRef.close(true);
