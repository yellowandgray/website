...
export class ConfigComponent implements OnInit {
  ...
  .subscribe(
    ...
    getHomeConfig(): void {
  this.httpClient.get<any>('api/v1/get_home_configs')
  .subscribe(
          (res)=>{
    ...
    getBannerAds(): void {
  this.httpClient.get<any>('api/v1/get_banner_advertisment')
  .subscribe(
          (res)=>{
    ...
    getCardAds(): void {
  this.httpClient.get<any>('api/v1/get_card_advertisment')
  .subscribe(
          (res)=>{
