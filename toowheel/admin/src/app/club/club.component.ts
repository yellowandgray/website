...
export class ClubComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    getClub(): void {
  this.httpClient.get<any>('api/v1/get_two_wheel_club')
  .subscribe(
          (res)=>{
  ...
  this.httpClient.get<any>('api/v1/get_four_wheel_club')
  .subscribe(
          (res)=>{
...
export class ClubForm {
    ...
    private httpClient: HttpClient) {
        ...
        this.httpClient.get('api/v1/get_states').subscribe(
              (res)=>{
    ...
    getCategory(): void {
       this.loading = true;
          this.httpClient.get('api/v1/get_'+this.clubForm.value.type+'_category').subscribe(
              (res)=>{
                this.loading = false;
                if(res["result"]["error"] === false) {
    ...
    getCityByState(): void {
       this.loading = true;
          this.httpClient.get('api/v1/get_city_by_state/'+this.clubForm.value.state).subscribe(
              (res)=>{
                this.loading = false;
                if(res["result"]["error"] === false) {
...
export class ClubDelete {
  ...
  confirmDelete() {
      ...
      this.loading = true;
      this.httpClient.get('api/v1/delete_record/club/club_id='+this.club_id).subscribe(
          (res)=>{
                this.loading = false;
                if(res["result"]["error"] === false) {
                    this.dialogRef.close(true);
