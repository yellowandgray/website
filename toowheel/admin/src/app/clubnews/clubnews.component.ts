...
openGalleryDialog(id): void  {
    const dialogRef = this.dialog.open(ClubNewsGalleryForm, {
        minWidth: "80%",
        maxWidth: "80%",
        data: {
            news_id: id
...
openView(id): void  {
        ...
        const dialogRef = this.dialog.open(ClubNewsViewForm, {
        minWidth: "80%",
        maxWidth: "80%",
        data: data,
        autoFocus: false
    ...
    const dialogRef = this.dialog.open(PictureViewClubNews, {
        minWidth: "40%",
        maxWidth: "40%",
        data: {
            data: data,
...
confirmDelete(id): void  {
    ...
    const dialogRef = this.dialog.open(ClubNewsDelete, {
        minWidth: "40%",
        maxWidth: "40%",
        data: data
    });
...
@Component({
  selector: 'clubnews-form',
  templateUrl: 'clubnews-form.html',
})
...
@Component({
  selector: 'clubnews-gallery-form',
  templateUrl: 'clubnews-gallery-form.html',
})
export class ClubNewsGalleryForm {
    loading = false;
    news_id:any;
    result:any[];
    image_url: string = 'https://www.toowheel.com/beta/toowheel/api/v1/';
    constructor(
    public dialogRef: MatDialogRef<ClubNewsGalleryForm>,
    @Inject(MAT_DIALOG_DATA) public data: any,
    private _snackBar: MatSnackBar,
    private httpClient: HttpClient) {
        this.news_id = this.data.news_id;
...
@Component({
  selector: 'clubnews-delete-confirmation',
  templateUrl: 'clubnews-delete-confirmation.html',
})
export class ClubNewsDelete {
    loading = false;
    news_id = 0;
    constructor(
    public dialogRef: MatDialogRef<ClubNewsDelete>,
    @Inject(MAT_DIALOG_DATA) public data: any,
    private _snackBar: MatSnackBar,
    private httpClient: HttpClient) {
        if(this.data != null) { 
...
export class PictureViewClubNews {
    image_url: string = 'https://www.toowheel.com/beta/toowheel/api/v1/';
    action: string = '';
    loading = false;
    member_id = 0;
    data: any;
    constructor(
    public dialogRef: MatDialogRef<PictureViewClubNews>,
  ...
  @Component({
  selector: 'clubnews-view-form',
  templateUrl: 'clubnews-view-form.html',
})
 
export class ClubNewsViewForm {
    image_url: string = 'https://www.toowheel.com/beta/toowheel/api/v1/';
    newsForm: FormGroup;
    loading = false;
    media_path: string;
    ...
    result:any[];
    constructor(
    public dialogRef: MatDialogRef<ClubNewsViewForm>,
