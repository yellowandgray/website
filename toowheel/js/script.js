            ...
            success: function (data) {
                ...
                if (data.result.error === false) {
                    ...
                    $.each(data.result.data, function (key, val) {
                        ...
                        div = div + '<div class="club-box pointer col-xl-3 col-sm-6" onclick="selectClub(' + val.club_id + ', this);"data-name="' + val.name + '" data-state="' + val.state_id + '" data-category="' + val.category_id + '"><div class="rank-button">' + rank + '</div><img src="' + BASE_IMAGE_URL + val.logo + '" alt="" /><h3>' + val.name + '</h3><p>' + val.city + '</p><div class="club-btn"><div class="eff-9"></div><a href="club-page?cid=' + val.club_id + '" target="_blank">Read More</a></div></div>';
                    });
