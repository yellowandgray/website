document.getElementById('contact-submit').onclick = function () {
    swal("Success", "Thank you! Our Team will get in touch with you soon.", "success");
};
    ...
    e.sweetAlert = e.swal = function () {
        ...
        for (var f = m(), d = function (e) {
            ...
            switch (e.type) {
                ...
                case "click":
                    if (n && a && o)
                        u.doneFunction(!0), u.closeOnConfirm && l();
                    else if (a && o) {
        ...
        }, g = f.querySelectorAll("button"), p = 0; p < g.length; p++)
