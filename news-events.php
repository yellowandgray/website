...
<html lang="en">
    ...
    <body>
        <div class="wrapper">
            ...
            <section class="wf100 about">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12 event-list-tap">
                            <div>
                                <p onclick="openCity('feb')">Feb 2019</p>
                                <p onclick="openCity('july')">July 2019</p>
                ...
                <section class="wf100 about month" id="feb">
    ...
    <!--                        <p class="text-center">(Feb 10, 2019 Sunday)</p>-->
                            <div class="row events-margin padding-bottom-30">
                                ...
                                <div class="col-md-6 event-justify">
                                    ...
                                    <p>ENPEE International School was launched in style on 10th Feb, the Sunday, at Hotel AVS Imperia, Karaikal. The school was inaugurated by the Hon’ble Speaker and former Chief Minister of Puducherry Union territory, Sri Ve Vaithilingam, in the presence of the Hon’ble Minister of Education Sri R.Kamalakannan in the presence of special invitees, parent with their children.</p>
                ...
                <section class="wf100 about month" id="oct" style="display: none">


                    <div class="about-video-section wf100 event-section" style="padding-bottom: 0; display:">
                        <div class="container" style="padding-bottom: 10px; border-bottom: 2px dashed #eee ;">
                            <h2 class="margin-bottom-0 text-center">WORLD FOOD DAY</h2> 
                            <p class="text-center"><strong>16th of October 2019</strong></p>
                            <br/>
    ...
    <!--                        <p class="text-center">(Feb 10, 2019 Sunday)</p>-->
                            <div class="row events-margin padding-bottom-30">
                                <div class="col-md-12">
                                    <div class="event-img-margin">
                                        <img src="images/food/0001.jpg" alt="Events" title="Events-ENPEE International School" />
                                        <p>World Food Day is celebrated every year across the world on 16th October. It is an annual celebration in the honor of the founding date of the Food and Agriculture Organization launched by the United Nation in the year 1947. To create an awareness about healthy food we organized an intraclass cooking without fire fest at ENPEE International School. Our wall magazine emphasized the importance of nutritious and healthy food habits. A variety of mouth-watering delicious dishes tempted and attracted each and everyone alike. Relishing and sharing the food, ensured that happiness reigned. Our children understood the benefits of consuming healthy fresh food. With added knowledge about World Food Day our juvenile returned home excited to brief their parent about their wonderful experience. #ENPEE #ENPEEInternation #CBSESchool #Karaikal #WorldFoodDay</p>
                                    </div>
                                </div>
                            </div>
                            <a type="button" href="events-food.php" class="btn-custom" style="position:relative; left:44%;">Read More</a>
                        </div>
                    </div>
                </section>
                ...
                <section class="wf100 about month" id="sep" style="display: none">
    ...
    <!--                        <p class="text-center">(Feb 10, 2019 Sunday)</p>-->
                ...
                <section class="wf100 about month" id="aug" style="display: none">
                    <div class="about-video-section wf100 event-section" style="padding-bottom: 0;">
                        <div class="container" style="padding-bottom: 10px; border-bottom: 2px dashed #eee ;">
    ...
    <!--                        <p class="text-center">(Feb 10, 2019 Sunday)</p>-->
                ...
                <!--About Txt Video End-->
                <!--About Txt Video Start-->
                <section class="wf100 about month" id="july" style="display: none">
                    <div class="about-video-section wf100 event-section" style="padding-bottom: 0;">
                        <div class="container" style="padding-bottom: 10px; border-bottom: 2px dashed #eee ;">
    ...
    <!--                        <p class="text-center">(Feb 10, 2019 Sunday)</p>-->
                            <div class="row events-margin padding-bottom-30">
                                <div class="col-md-6">
                                    <img src="images/upcoming-events-go-green.png" alt="GO Green">
                                </div>
                                <div class="col-md-6 event-justify">
    ...
    <!--                        <p class="text-center">(Feb 10, 2019 Sunday)</p>-->
                ...
                <section class="wf100 about month" id="dec" style="display: none">
                    <div class="about-video-section wf100 event-section" style="padding-bottom: 0;">
                        <div class="container" style="padding-bottom: 10px; border-bottom: 2px dashed #eee ;">
                            <h2 class="margin-bottom-0 text-center">Basic Life Support (BLS) Training</h2> 
                            <p class="text-center">(5th of Dec 2019)</p>
                            <br/>
    <!--                        <center>(On Wednesday, the 10<sup>th</sup> of July 2019,.at 10 a.m in our School premises)</center>-->
    <!--                        <p class="text-center">(Feb 10, 2019 Sunday)</p>-->
                            <div class="row events-margin padding-bottom-30">
                                <div class="col-md-12">
                                    <div class="event-img-margin">
                                        <img src="images/events/bls/001.jpg" alt=""/>
                                        <p>Learning is a continuous process. It is not age restricted. This is one of the reasons that we call our children as Learners than students. School is a second home for the children hence we assure that we are well equipped with all necessary requirements for them . In terms of health, hygiene, food, academics, physical activities etc..</p>
                                    </div>
                                </div>
                            </div>
                            <a type="button" href="events-bls.php" class="btn-custom" style="position:relative; left:44%;">Read More</a>
                        </div>
                    </div>
                    <div class="about-video-section wf100 event-section" style="padding-bottom: 0;">
                        <div class="container" style="padding-bottom: 10px; border-bottom: 2px dashed #eee ;">
                            <h2 class="margin-bottom-0 text-center">CHRISTMAS CELEBRATIONS AT ENPEE</h2> 
                            <p class="text-center">(22th of Dec 2019)</p>
                            <br/>
    <!--                        <center>(On Wednesday, the 10<sup>th</sup> of July 2019,.at 10 a.m in our School premises)</center>-->
    <!--                        <p class="text-center">(Feb 10, 2019 Sunday)</p>-->
                            <div class="row events-margin padding-bottom-30">
                                <div class="col-md-12">
                                    <div class="event-img-margin">
                                        <img src="images/events/christmas/01.jpg" alt=""/>
                                        <p>December being the last month of the year is always joyful and filled with love and warmth. ENPEE INTERNATIONAL SCHOOL was completely decorated with red and green around. The celebration went on well with the support extended by our valuable parents and the management There was a treat given by the children through their Christmas Carols, jingle dance by the Kinder garten beauties, a skit and solo dance performance . Yes we did not forget the Santa, the little Santa came with various gifts to the children of ENPEE INTERNATIONAL SCHOOL. Let this Christmas bring true love, joy, good health and peace to all. May the birthday of Jesus Christ enlighten everyone one of yours life with happiness and courage. ENPEE INTERNATIONAL SCHOOL wishes you all a merry Christmas and a prosperous New year 2020.</p>
                                    </div>
                                </div>
                            </div>
                            <a type="button" href="events-christmas.php" class="btn-custom" style="position:relative; left:44%;">Read More</a>
                        </div>
                    </div>
                </section>
                <!--About Txt Video End-->
