...
//    $business_url = $_REQUEST['business-url'];
    ...
    $right = $_REQUEST['right_list'];
    $connect = $_REQUEST['connect_list'];
...
//    $message = $_REQUEST['requirement'];
    ...
    $message = '<table border = "0" cellpadding = "0" cellspacing = "0" height = "100%" width = "100%">
            ...
            <h3 style = "margin:0 0 16px; text-align:center;">Opportunity Call Application Form Details.</h3>
            ...
            <p style = "margin:0 0 16px"><strong>RIGHT NOW I...:</strong> ' . implode(',', $right) . ',</p>
            <p style = "margin:0 0 16px"><strong>How would you like us to connect:</strong> ' . implode(',', $connect) . ',</p>
