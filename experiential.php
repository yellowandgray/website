...
<html lang="en">
    ...
    <body class="subpage">
        ...
        <section class="ptb-80 bg-cream">
            <!--            <div class="divider divider-custom-7"></div>-->
            <div class="container">
                <div class="row justify-content-center text-center">
                    <div class="col-md-9 col-lg-8 col-xl-7">
                        <h3 class="display-4 pb-40">EXPERIENTIAL LEARNING</h3>
                        <div class="lead"></div>
                    </div>
                </div>
                        ...
                        <div class="tensorsite-group__inner">
                            ...
                            <div class="col-md-4" data-aos-delay="200" data-aos="fade-left">
                                <div class="tensorsite-card tensorsite-card--clip">
                                    <a class="tensorsite-card__href" aria-label="Your first neural network" href="#"></a>
                                    <div class="tensorsite-content__image-wrapper">
                                        <img class="tensorsite-content__image" src="img/experiential/artificial-intelligence.jpg" alt="">
                                    </div>
                                    <div class="tensorsite-content  tensorsite-content--under-image">
                                        <!--                                        <div class="tensorsite-content__clip-bg">
                                                                                    <svg class="tensorsite-content__clip-shape" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 409 132"><path class="color-green" d="M71.2,3.2,0,44v88H409L92.3,1.8A24.1,24.1,0,0,0,71.2,3.2Z" fill="#fff"></path></svg>    
                            ...
                            <div class="col-md-4" data-aos-delay="200" data-aos="fade-left">
                                <div class="tensorsite-card tensorsite-card--clip">
                                    <a class="tensorsite-card__href" aria-label="Your first neural network" href="#"></a>
                                    <div class="tensorsite-content__image-wrapper">
                                        <img class="tensorsite-content__image" src="img/experiential/analytics.jpg" alt="">
                                    </div>
                                    <div class="tensorsite-content  tensorsite-content--under-image">
                                        <!--                                        <div class="tensorsite-content__clip-bg">
                                                                                    <svg class="tensorsite-content__clip-shape" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 409 132"><path class="color-green" d="M71.2,3.2,0,44v88H409L92.3,1.8A24.1,24.1,0,0,0,71.2,3.2Z" fill="#fff"></path></svg>    
                            ...
                            <div class="col-md-4" data-aos-delay="200" data-aos="fade-left">
                                <div class="tensorsite-card tensorsite-card--clip">
                                    <a class="tensorsite-card__href" aria-label="Your first neural network" href="#"></a>
                                    <div class="tensorsite-content__image-wrapper">
                                        <img class="tensorsite-content__image" src="img/experiential/3d-printing.jpg" alt="">
                                    </div>
                                    <div class="tensorsite-content  tensorsite-content--under-image">
                                        <!--                                        <div class="tensorsite-content__clip-bg">
                                                                                    <svg class="tensorsite-content__clip-shape" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 409 132"><path class="color-green" d="M71.2,3.2,0,44v88H409L92.3,1.8A24.1,24.1,0,0,0,71.2,3.2Z" fill="#fff"></path></svg>    
                            ...
                            <div class="col-md-4" data-aos-delay="200" data-aos="fade-left">
                                <div class="tensorsite-card tensorsite-card--clip">
                                    <a class="tensorsite-card__href" aria-label="Your first neural network" href="#"></a>
                                    <div class="tensorsite-content__image-wrapper">
                                        <img class="tensorsite-content__image" src="img/experiential/machine-learning.jpg" alt="">
                                    </div>
                                    <div class="tensorsite-content  tensorsite-content--under-image">
                                        <!--                                        <div class="tensorsite-content__clip-bg">
                                                                                    <svg class="tensorsite-content__clip-shape" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 409 132"><path class="color-green" d="M71.2,3.2,0,44v88H409L92.3,1.8A24.1,24.1,0,0,0,71.2,3.2Z" fill="#fff"></path></svg>    
        ...
        <section class="bg-primary-3 text-white ptb-80">
            <div class="divider divider-custom-8 transform-flip-x"></div>
            <div class="container">
