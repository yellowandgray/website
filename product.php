        ...
        <section class="ftco-section" style="background-image: url('images/bg_3.jpg'); background-size: cover;">
            <div class="pad-lr-80">
                <div class="row product-2">
                    <div class="col-lg-8 product-details pl-md-5 ftco-animate">
                        <h3>BZ1 Binder</h3>
                        <p>Fresche BZ1 is a non-formaldehyde containing polymeric resin used with the Fresche EF3851 and EF4850 series antimicrobials to improve durability of anti microbial protection when applied to synthetics, cellulosics, and their blends.</p>
