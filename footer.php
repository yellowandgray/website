                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <div class="footer-widget">
                        ...
                        <ul class="quick-links">
                            ...
                            <li> <a href="chateau-francais.php">Château Français</a> </li>
...
<!--                                <span class="pdate"><i>Date:</i> 14 May 2019</span> -->
                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <div class="footer-widget">
                        ...
                        <p><strong>ENPEE International School</strong><br/><span class="light-green">Château Français</span><br/>ENPEE Enclave,<br/> 241/2, Puthakudy Village, <br/>Vadamattam Main Road,<br/>Nedungadu Panchayat,<br/>Karaikal – 609609. <br/>U.T of Puducherry.</p>
            ...
            <div class="row">
                ...
                <div class="col-lg-5">
                    <div class="footer-social"> 
                        ...
                        <a href="https://www.facebook.com/ENPEEInternationalSchool" target="blank" class="facebook-color"><i class="fab fa-facebook-f"></i><span></span></a> 
...
// Get the image and insert it inside the modal - use its "alt" text as a caption
    ...
    img.onclick = function () {
        modal.style.display = "block";
        modalImg.src = "images/anual-cornival-01.jpg";
//        captionText.innerHTML = this.alt;
    }
