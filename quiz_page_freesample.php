...
<?php include 'menu.php'; ?>
        <div class="quiz-section" <?php if ($quiz_from_page != 'quiz') {
    ...
    <?php } ?>
                                ...
                                <!-- <p class="subtitle">
                                    ...
                                    <div class="">
                                        ...
                                        <h4><strike>₹999 </strike> &nbsp;&nbsp; <span> ₹499</span> <span style="font-size: 15px;">(Inclusive in 18% GST)</span></h4>
                                        <a href="register_user" class="btn btn-green" style="font-size: 18px;text-transform: none">Buy Full Version</a>
    <?php /*
