            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p class="text-justify">problem solving skills among the young students.</p>
                        <p class="text-justify">mathematical questions presented through various figures, charts, and scenarios closely related to real-life situations</p>
                        <p class="text-justify">challenge and improve their problem-solving approach and capability.</p>
                        <p class="text-justify">Significantly helps the overall development of each student.</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
