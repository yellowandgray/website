...
//    $social_media = $_REQUEST['social_media'];
    ...
    $mail->Host = "mail.medikal.com.my";      // sets GMAIL as the SMTP server

    $mail->Port = 465;                   // set the SMTP port for the GMAIL server

    $mail->Username = "noreply@medikal.com.my";  // GMAIL username

    $mail->Password = "Admin@medikal";            // GMAIL password
    $mail->IsHTML(true);
    $mail->SetFrom('noreply@medikal.com.my', 'ALIAS');
