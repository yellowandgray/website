...
<html lang="zxx">
    ...
    <body data-spy="scroll" data-target=".header" data-offset="50">
                ...
                <div class="row">
                    <div class="col-lg-7">
                        <div class="hero-area-content">
                            <h1>Churchlink</h1>
                            <p>A web application providing a safe and secure connection between the church and the members. This web application enables the church to have a complete control and manage over the entire activities.</p>
        ...
        <section class="feature-area ptb-90" id="feature">
            <div class="container">
                <div class="sec-title">
                    <h2>Web App at a Glance<span class="sec-title-border"><span></span><span></span><span></span></span></h2>
                        ...
                        <div class="contact-address">
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div class="contact-address-info">
                                        <a href="mailto:joshuva.clements@gmail.com">joshuva.clements@gmail.com</a>
