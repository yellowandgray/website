    ...
    <body>
        ...
        <section class="section">
            <div class="container">
                ...
                <div class="row">
                    <div class="tab">
                        <button class="tablinks" onclick="openCity(event, 'Features')" id="defaultOpen">Core Features</button>
                        <button class="tablinks" onclick="openCity(event, 'Office')" id="defaultOpen">Back Office Features</button>
                        <button class="tablinks" onclick="openCity(event, 'Support')" id="defaultOpen">Support Features</button>
                    ...
                    <div id="Functional" class="tabcontent">
                        <div class="faqmain-info" style="margin-top: 20px;">
                            <div class="faq-subinfo">
                                <img src="images/healthcare/functional-flow.png" alt="" class="img-responsive" />
                                <div class="clearfix"> </div>
                            </div>
                        </div> 
                    </div>
