                ...
                <div class="container">
                    ...
                    <div class="row coach">
                        ...
                        <div class="method-coaching wow fadeInUp">
                            <a href="#enquiry">
                                <h2>Workshops & Mastermind Circles</h2>
                    ...
                    <div class="row">
                        <div class="col-md-12 wow fadeInUp">
                            <ul class="list-1 wow fadeInUp">
                                ...
                                <i class="fa fa-arrow-right" aria-hidden="true"></i><li>Your Partnership with Cheryl will begin with an initial 2-hour Deep Discovery session where you will uncover what you truly want,<strong style="text-decoration:underline; font-style:italic;"> what held you back and begin discovering the path to get you where you want to be.</strong></li>
