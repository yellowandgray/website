...
<html lang="en">
    ...
    <body>
        <div class="wrapper">
            ...
            <!--Header End-->
            <!--Inner Header Start-->
            <section class="wf100 p100 inner-header inner-header-01">
                <div class="container">
                    <h1>Blue Room</h1>
                    <ul>
                        <li><a href="#">Home</a></li>
                        <li><a href="#">Services</a></li>
                        <li><a href="#">Blue Room</a></li>
                    </ul>
                </div>
            </section>
            <!--Inner Header End--> 
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="wildlife" role="tabpanel" aria-labelledby="wildlife-tab">
                                        <div class="cpro-slider owl-carousel owl-theme">
                                            ...
                                            <div class="item">
                                                <div class="pro-box">
                                                    <img src="images/blue/002.jpg" alt="">
                                                    <h5>Brainstorm Sessions</h5>
                                                    <div class="pro-hover">
                                                        <h6>Brainstorm Sessions</h6>
                                                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                                        <a href="#">Read More</a> 
                                                    </div>
                                                </div>
                                            ...
                                            <div class="item">
                                                <div class="pro-box">
                                                    <img src="images/blue/003.jpg" alt="">
                                                    <h5>Field Visit</h5>
                                                    <div class="pro-hover">
                                                        <h6>Field Visit</h6>
                                                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                            ...
                                            <div class="item">
                                                <div class="pro-box">
                                                    <img src="images/blue/004.jpg" alt="">
                                                    <h5>Others</h5>
                                                    <div class="pro-hover">
                                                        <h6>Others</h6>
                                                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                    ...
                                    <div class="blog-post">
                                        ...
                                        <div class="blog-slider">
                                            <div id="bslider" class="owl-carousel owl-theme">
                                                <div class="item"> <img src="images/blue/005.jpg" alt=""> </div>
                                                <div class="item"> <img src="images/blue/006.jpg" alt=""> </div>
                                                <div class="item"> <img src="images/blue/007.jpg" alt=""> </div>
                                            </div>
                                        </div>
