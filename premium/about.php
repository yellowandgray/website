                ...
                <div class = "container">
                    <div class = "row">
                        <div class = "span6">
                            ...
                            <div class="about-ul">
                                <ul>
                                    <i class="icon-double-angle-right" aria-hidden="true"></i><li>The concept of Microlearning through the Visual Memory helps the Smart Neuron to Remember, Recollet, and Reproduce in a much faster way and much longer</li>

                                    <i class="icon-double-angle-right" aria-hidden="true"></i><li>Understanding of the concept at the micro-level builds up the ladder.</li>
