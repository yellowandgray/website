                ...
                <div class="row flexbox-center">
                    <div class="col-lg-2 col-md-3 col-6">
                        <div class="logo">
                            ...
                            <a href="index.php"><img class="logo-1" src="assets/img/logo1.png" alt="logo" /></a>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="sec-title">
                            ...
                            <p>Christlink offers some amazing features – First time Globally</p>
                        </div>
                    </div>
                </div>
                <div class="row">
