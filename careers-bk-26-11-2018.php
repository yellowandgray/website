                    ...
                    <form action="" method="post" role="form" class="contactForm">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="file" name="pic" accept="pdf,doc,docx,image/*">
                                <div class="validation"></div>
                            </div>
                        </div>
