            ...
            <div class="container">
                <div class="row rs-vertical-middle">
                    <div class="col-lg-3 col-md-12 width-20">
                        <div class="logo-area">
                            <a href="index.php"><img src="images/logo.png" alt="logo" class="img-align"></a>
                        </div>
                    </div>
                        ...
                        <div class="main-menu">
                            ...
                            <nav class="rs-menu font">
                                <ul class="nav-menu nav-1 font-12">
                                    ...
                                    <li class="<?php if($page == 'franchise'){ echo 'active';} ?>"> <a href="franchise-opportunities.php">FRANCHISE OPPORTUNITIES</a></li>
