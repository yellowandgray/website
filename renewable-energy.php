        ...
        <div class="wrapper industry">
            ...
            <section class="wf100 p80">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="tab renewable-energy-1">
                        ...
                        <div class="col-md-12">
                            <div id="dc-dc" class=" tabcontent">
                                <section class="wf100 pad-t-40">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-8 wow fadeInLeft">
                                                <div class="renewable-energy">
                                                    <h3>DC JUNCTION BOXES PHOTOVOLTAIC(DCBJ)1050-1500 VDC</h3><br>
                                                    <h3>Coffrets de jonction continu Photovoltaiques(DCBJ)1050-1500 VDC</h3><br>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 wow fadeInLeft">
                                                <div class="renewable-energy">
                                                    ...
                                                    <ul class="data-list">
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Expert control till net metering.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Variants and types of devices as per applications.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Competitive in cost for small residential and commercial systems</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Real time monitoring - 1min logs</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Grid and DG side monitoring and comparison with solar</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Load monitoring.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>PR-daily,weekly,monthly,yearly and also PR-YTD.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Expected and actual generation comparison.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Alert System - mails and messages</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Local data storage and upload to portal in case of internet failure.</li>
                                                    </ul>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 wow fadeInLeft">
                                                <div class="renewable-energy">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <ul class="data-list">
                                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Innovative solar monitoring to maximize ROI.</li>
                                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Real time monitoring and alerts reduce downtime and losses.</li>
                                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Easy O & M and Asset management - Identifies under-performing assets and their impact with preventive and corrective maintenance tool.</li>
                                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Root cause analysis of energy loss</li>
                                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Dashboards for easy visualization.</li>
                                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Retrofit for any MODBUS network(RS485/RS232)</li>
                                                        ...
                                                        <div class="col-md-6 wow fadeInRight">
                                                            <ul class="data-list">
                                                                ...
                                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Effective and to the point solutions</li>
                                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Steer the future with innovations in solar.</li>
                                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Informative and convincing data analysis</li>
                                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Avoid erroneous data</li>
                                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Measure acquire analyze innovate.</li>  
                                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Cutting edge technology with domain expertise.</li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 wow fadeInLeft">
                                                <div class="renewable-energy">
                                                    ...
                                                    <ul class="data-list">
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Designed to cater for renewable energy application</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Wide input voltage range:170VDC to 1000VDC.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Industrial grade operating temperature: -10 degree celsius to +80 degree celsius.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Isolation voltage up to 4.5KVAC.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Efficiency upto 90%.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Low voltage lockout</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Low ripple,Low noise.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Inbuilt protections like reverse input voltage protection,output short circuit,over-voltage protection.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>High reliability and long life.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>DIN-Rail mounting.</li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="col-md-6 img-2 wow fadeInRight">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 wow fadeInLeft">
                                                <div class="renewable-energy">
                                                    <h3>BENEFITS OF THE RANGE</h3><br>
                                                    <ul class="data-list">
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Designed to cater for Renewable energy applications.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Wide Input voltage range:100VDC to 1000VDC.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Industrial grade operating temperature: -10 degree celsius to +80 degree celsius.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>High isolation voltage up to 4.5KVAC.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>High efficiency in its class-up to 90%.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Low ripple,Low noise</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Inbuilt protections like reverse input voltage protection,Output short circuit protection,Over-voltage protection.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>High reliability and long life.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Mounting flexibility:PCB mounting,DIN-Rail mounting.</li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="col-md-6 img-2 wow fadeInRight">
                                            ...
                                            <div class="col-md-6 wow fadeInLeft">
                                                <div class="renewable-energy">
                                                    ...
                                                    <ul class="data-list">
                                                        ...
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Industrial grade operating temperature: -10 degree celsius to +80 degree celsius.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>High isolation voltage up to 4.5KVAC.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>High efficiency in its class-up to 86%.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Low ripple,Low noise</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Inbuilt protections like reverse input voltage protection,Output short circuit protection,Over-voltage protection.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>High reliability and long life.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Mounting flexibility:DIN-Rail mounting.</li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="col-md-6 img-2 wow fadeInRight">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 img-2 wow fadeInUp">
                                                <div class="renewable-energy">
                                                    ...
                                                    <img src="images/renewable-energy/possibilities.jpg" alt="" class="img-responsive"/>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 wow bounceInLeft">
                                                <div class="renewable-energy">
                                                    <h3>FEATURES</h3><br>
                                                    <ul class="data-list">
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Range - 8/12/16/24 input channels for current.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>1 input channel for voltage -1000V or 1500V.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>1 on board temperature sensor.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>2 input channels for temperature.(PT100)</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>4 digital inputs</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>RS 485 MODBUS/Wireless interface.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Stud or screw mounting.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Wireless option available - Low power long range and reliable data transfer</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Shunt based monitoring increases accuracy.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Very low power consumption <3W.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Robust and reliable.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Calculated DC Power,alarms,status etc.can be monitored by using Modbus.</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div><br>
                            ...
                            <div id="wire_less" class="tabcontent">
                                <section class="wf100 p80">
                                    <div class="container">
                                            ...
                                            <div class="col-md-12 wow bounceInLeft">
                                                <div class="renewable-energy">
                                                    ...
                                                    <p class="text-justify">Low-Power consumption and long range LoRa Technology transceiver module provides an easy to use wireless data transfer. The advanced command interface offers rapid time to market. It integrates RF, a baseband controller, command application, programming interface (API) processor, making it a complete long range solution. This module is suitable for simple long range sensor and wireless applications with an external host MCU.
                                                        ...
                                                        LoRa Technology modulation also provides significant advantages in both blocking and selectivity compared to the conventional modulation techniques, solving the traditional design compromise between extended range, interference immunity, and low-power consumption.</p>
                                                </div>
                                            </div>
                                        </div><br>
                                        ...
                                        <div class="row wow bounceInLeft green-box">
                                            <div class="col-md-1">
                                            </div>
                                            <div class="col-md-2">
                                                <div class="text-center">
                                                    <div class="renewable-energy img-3 text-center">
                                                        <img src="images/renewable-energy/tertiary.png"  alt="" />
                                                        <h5>Teritary</h5>
                                                    </div>  
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="renewable-energy img-3 text-center">
                                                    <img src="images/renewable-energy/industry.png"  alt="" />
                                                    <h5>Industry</h5>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="renewable-energy img-3 text-center">
                                                    <img src="images/renewable-energy/energy-storage.png"  alt="" />
                                            ...
                                            <div class="col-md-2">
                                                <div class="renewable-energy img-3 text-center">
                                                    <img src="images/renewable-energy/transport.png"  alt="" />
                                                    <h5>Transport</h5>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="renewable-energy img-3 text-center">
                                                    <img src="images/renewable-energy/renewable-energies.png"  alt="" />
                                        ...
                                        <div class="row pad-t-40">
                                            <div class="col-md-12">
                                                <div class="renewable-energy">
                                                    <ul class="data-list">
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Solar- Trackers, SMB(String monitoring box),Data loggers,SCADA etc.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Building and Home Automation.</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Wireless Alarm and security systems</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Industrial monitoring and control</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Machine to Machine(M2M).</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Internet of things(IOT).</li>
                                                        <i class="fa fa-hand-o-right" aria-hidden="true"></i><li>Smart Metering.</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
