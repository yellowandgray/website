...
function extendthemes_remote_notifications_handle($data)
{
    ...
    <div class="extendthemes-remote-notification extendthemes-remote-notification-<?php echo esc_attr($data['notification_id']); ?>">
        ...
        <style>
            [data-cp-notification-name="extendthemes_remote_notification_one-page-express_<?php echo $data['notification_id']; ?>"] {
                background-image: url("<?php echo $data['background_image'];?>");
                background-size: cover;
                background-repeat: no-repeat;
            }

            [data-cp-notification-name="extendthemes_remote_notification_one-page-express_<?php echo $data['notification_id']; ?>"] .message p:first-child {
                font-size: 20px;
            }
