...
<html lang="en">
    ...
    <body class="goto-here">
        ...
        <section class="ftco-section" style="background-image: url('images/bg_03.png'); background-size: cover;">
            <div class="pad-lr-80">
                <div class="row">
                    <div class=" text-center col-lg-12 product-details pl-md-5 ftco-animate">
                        <h3 >About ANTIMICROBIALS</h3>
                        ...
                        <p class="font-weight-bold">Antimicrobial is a generic term that is used for all products and technologies that assist us to keep this microbial in control.</p>
                        <p class="font-weight-bold">It is a huge Industry that supports the healthy existence of Human Beings in a silent manner. </p>
            ...
            <div class="pad-lr-80">
                <div class="row">
                    ...
                    <div class="col-lg-8 product-details pl-md-5 ftco-animate">
                        <h3>Healthcare</h3>
                        <h5>Spread of Hospital Acquired Infections (HAI) is a global crisis</h5>
                        <p>Standard disinfectants are either ineffective or highly corrosive in nature.</p>
                        <p>This is because most disinfectants are leaching chemicals. This makes them not only futile against deadly infections, but also increase antimicrobial resistance in pathogens, and drastically increases spread of infections.</p>
                        <p>Apart from this the added burden of human error factor during every application increases the operation costs exponentially.</p>
                        <!--<button class="button-03"><a href="#"><i class="fa fa-cart-plus" aria-hidden="true"></i>  Add To Cart</a></button>-->
                    </div>
                </div>
            </div>
