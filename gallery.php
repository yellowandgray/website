                ...
                <nav class="navbar navbar-default">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="item-101 hovernav">
                                <a href="index.php#manger" class="scroll">Innovation</a>
                            </li>
                            <li class="item-101 hovernav">
                                <a href="index.php#why-us" class="scroll">Why Us</a>
                            </li>
                            <li class="item-101 hovernav">
                                <a href="index.php#support-hub" class="scroll">Support Hub</a>
                            </li>
                            <li class="item-101 hovernav">
                                <a href="index.php#team" class="scroll">Team</a>
                            </li>
                            <li class="item-101 hovernav">
                                <a href="index.php#gallery" class="scroll">Media</a>
                            </li>
                            <li class="item-101 hovernav">
                                <a href="index.php#testimonials" class="scroll">Clients</a>
                            </li>
                            <li class="item-101 hovernav">
                                <a href="index.php#contacts" class="scroll">Contact</a>
                            </li>
                        </ul>
                    </div>
                    <div class="clearfix"> </div>
        ...
        <div id="about" class="section">
            <div class="container-fluid">
                ...
                <div class="tab">
                    ...
                    <button class="tablinks" onclick="openCity(event, 'World-Congress-On-IT')">World Congress On IT</button>
                    <button class="tablinks" onclick="openCity(event, 'Connectivity-Program')">Connectivity Program</button>
                    <button class="tablinks" onclick="openCity(event, 'Building-a-Brand')">Building a Brand</button>
                ...
                <div id="E-kedai" class="tabcontent">
                    <div class="tab-content-padding">
                        ...
                        <section class="customer-logos slider">
                            ...
                            <div class="slide"><img class="zoom" src="images/gallery-1/00/003.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/00/004.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/00/005.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/00/006.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/00/007.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/00/008.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/00/009.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/00/010.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/00/011.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/00/012.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/00/013.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/00/014.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/00/015.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/00/016.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/00/017.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/00/018.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/00/019.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/00/020.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/00/021.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/00/022.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/00/023.jpg" alt=""/></div>
                        </section>
                    </div>
                </div>
                ...
                <div id="World-Congress-On-IT" class="tabcontent">
                    <div class="tab-content-padding">
                ...
                <div id="Connectivity-Program" class="tabcontent">
                    <div class="tab-content-padding">
                ...
                <div id="dhaka-sessions" class="tabcontent">
                    <div class="tab-content-padding">
                        ...
                        <section class="customer-logos slider">
                            <div class="slide"><img class="zoom" src="images/gallery-1/10/001.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/10/002.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/10/003.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/10/004.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/10/005.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/10/006.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/10/007.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/10/008.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/10/009.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/10/010.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/10/012.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/10/013.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/10/014.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/10/015.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/10/016.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/10/017.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/10/018.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/10/019.jpg" alt=""/></div>
                            <div class="slide"><img class="zoom" src="images/gallery-1/10/020.jpg" alt=""/></div>
                        </section>
                    </div>
                </div>
                ...
                <div class="tab tab-1">
                    ...
                    <button class="tablinks" onclick="openCity(event, 'ic-collaboration')">iContent Collaboration</button>
                    <button class="tablinks" onclick="openCity(event, 'dhaka-sessions')">The Dhaka Sessions</button>
