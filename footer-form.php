...
if ($_POST['name']) {
    ...
    $message = '<table border = "0" cellpadding = "0" cellspacing = "0" height = "100%" width = "100%">
            ...
            <h1 style = "color:#ffffff;font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;font-size:30px;font-weight:300;line-height:150%;margin:0;text-align:center"><img src = "http://projectnextdoor.com/img/logo.png" alt = "Project Next Door" style = "width:50%" /></h1>
            </td>
            </tr>
            </tbody>
            </table>
