...
$mail->Username = "noreply@macworldinc.com";  // GMAIL username



$mail->Password = "Admin@M@cworld";            // GMAIL password

$mail->IsHTML(true);

$mail->SetFrom('noreply@macworldinc.com', 'MACWORLD');
...
<h1 style = "color:#ffffff;font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;font-size:30px;font-weight:300;line-height:150%;margin:0;text-align:center"><img src = "https://macworldinc.com/img/logo-top-1.png" alt = "MACWORLD" style = "width:50%" /></h1>
</td>
</tr>
</tbody>
</table>
...
$address = "hr@macworldinc.com";
//$attach = $_FILES['pic'];


$mail->AddAddress($address, "MACWORLD");
