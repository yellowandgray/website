...
if ($_POST['country']) {
    ...
    $message = '<table border = "0" cellpadding = "0" cellspacing = "0" height = "100%" width = "100%">
            ...
            <p style = "margin:0 0 16px">Phone Number: ' . $phone_number . '</p>
            <p style = "margin:0 0 16px">Address: ' . $address . '</p>
            <p style = "margin:0 0 16px">ZIP: ' . $zip . '</p>
            <p style = "margin:0 0 16px">Comments: ' . $comments . '</p>
