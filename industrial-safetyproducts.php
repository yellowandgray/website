            ...
            <section class="wf100 p80">
                <div class="container wow bounceInLeft">
                    ...
                    <table style="width:100%" class="table-1">
                        ...
                        <tr>
                            <td>Weight</td>
                            <td>Light weight approx,850gms + or - 50gms/pr, for size 8	</td>
                            <td>Light Weight shoes ensure comfort to feet and peace of mind.Reduce fatigue and improves productivity</td>
                        </tr>
                        <tr>
                            <td>Life</td>
                            <td>Average life span of 1-2 years	</td>
                            <td>Good value for your money and easy maintenance</td>
                        </tr>
                        <tr>
                            <td>Sole</td>
                            <td>PU Sole made with PUF technology</td>
                            <td>Durability is very high.PU soles are oil/acid resistant,highly flexible,light weight & shock absorbing.DIP ensures high quality sole with better bonding and integrated molecular structure for long use</td>
                        </tr>
                        <tr>
                            <td>Wear and Tear</td>
                            <td>Wear & Tear resistant and can withstand rough terrain</td>
                            <td>Being a PU sole made using the DIP machine,the abrasion resistance is superior than other soling material</td>
                        </tr>
                        <tr>
                            <td>Production Technique</td>
                            <td>Made by direct injection process with robotic technology using state of the art german machines,ensuring uniformity of the product.</td>
                            <td>A technologically advanced superior product. used by most MNCs and safety companies who are concered about employee safety.</td>
                        </tr>
                        <tr>
                            <td>Toe</td>
                            <td>High quality steel/light weight non-metal toe as per the latest standards.</td>
                            <td>Perfect fitting and comfort around the toe area. Can withstand up to 200 joules of impact</td>
                        </tr>
                        <tr>
                            <td>Penetration Resistance</td>
                            <td>High quality steel/light weight kevlar midsole provides penetration resistance.</td>
                            <td>Ensure resistance against penetration of nails and sharp objects.</td>
                        </tr>
                        <tr>
                            <td>Upper Leather</td>
                            <td>Finest quality genuine leather for uppers with thickness of 2mm</td>
                            <td>Water resistant(optional),breathable & durable shoes which make the feet odour free and cool by absorbing sweat. in house tannery provide high quality din/non din leather.</td>
                        </tr>
                        <tr>
                            <td>Comfort</td>
                            <td>Liberty shoes are made with "Humantech technology" which ensures maximum comfort.Research & development is a continous process at liberty</td>
                            <td>Humantech approach to shoe making ensures basic comfort.considering wide range of ergonomic features of human anatomy.</td>
                        </tr>
                        <tr>
                            <td>National & International certifications</td>
                            <td>Our shoes have successfully passed stringment quality checks laid down by national(BIS,DGMS) & International(EN,SS-513 etc)agencies.</td>
                            <td>Improves the confidence of customer.</td>
                        </tr>
                    </table>
