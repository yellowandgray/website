...
<html lang="zxx">
    ...
    <body class="inner-page">
        ...
        <!-- Breadcrumbs Start -->
        <div class="rs-breadcrumbs breadcrumbs-overlay" style="background: url(images/sub-banner/sub-07.jpg)no-repeat; background-size: cover;">
                    ...
                    <div class="col-md-12 wow fadeInUp">
                        ...
                        <div class="row">
                            <div class="col-md-4 text-center">
                                <div class="box-hover">
                                    <h3>US$102.8B</h3>
                                    <p>The Projected Size of the Global Private Tutoring Market by 2018</p>
                            ...
                            <div class="col-md-4 text-center">
                                <div class="box-hover">
                                    <h3>90%</h3>
                                    <p>of the Global Market is represented by Asia</p>
                                    <br/>
                                </div>
                            </div>
                            <div class="col-md-4 text-center">
                                <div class="box-hover">
                                    <h3>US$227B</h3>
                                    <p>The Forecasted Global Market for Private Tutoring Services by 2022</p>
                                    <br/>
                                </div>
                            </div>
                        </div>
...
<!--                    <p>Fusce sem dolor, interdum in efficitur at, faucibus nec lorem. Sed nec molestie justo.</p>-->
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <p>Over 17 years of Experience</p>
                    </div>
                    <div class="col-md-3">
                        <div class="rs-counter-list">
