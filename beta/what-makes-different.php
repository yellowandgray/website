...
<!--            <section class="testimonials-section wf100 p80">
                <h2 class="text-center">Testimonials Coming Soon..</h2>
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div id="h3testimonials" class="owl-carousel owl-theme">
                                ...
                                <div class="item">
                                    ...
                                    <div class="tuser"> <img src="images/tuser1.jpg" alt=""> <strong>Richardson</strong> Florida Partner </div>
                                </div>
                                testimonials box End 
                                testimonials box start
                                <div class="item">
                                    ...
                                    <div class="tuser"> <img src="images/tuser1.jpg" alt=""> <strong>Anna Lillian</strong> Florida Partner </div>
                                </div>
                                testimonials box End 
                                testimonials box start
                                <div class="item">
