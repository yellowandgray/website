<div class="top-bar py-2 bg-light" id="home-section">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-6">
                <p class="mb-0 float-right social-icon">
                    <span class="mr-3"><a href="tel://+91-8056120222"> <span class="icon-phone mr-2" style="position: relative; top: 2px;"></span><span class="d-none d-lg-inline-block text-black">(+91) 80561 20222</span></a></span>
                    <span class="mr-3"><a href="mailto:info@ruseodor.com"><span class="icon-envelope mr-2" style="position: relative; top: 2px;"></span><span class="d-none d-lg-inline-block text-black"><span class="__cf_email__" data-cfemail="d7a4bfb8a797aeb8a2a5b3b8bab6beb9f9b4b8ba">info@ruseodor.com</span></span></a></span>
...
<header class="site-navbar py-4 bg-white js-sticky-header site-navbar-target" role="banner">
    <div class="container-fliud" style="padding: 0 80px;">
        <div class="row align-items-center">
            ...
            <div class="col-6 d-inline-block d-xl-none ml-md-0 py-3" style="position: relative; top: 10px;"><a href="#" class="site-menu-toggle js-menu-toggle text-black float-right"><span class="icon-menu h3"></span></a></div>
        </div>
    </div>
</header>