                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="event-post">
                                    ...
                                    <div class="event-txt">
                                        <h5>
                                            <a href="#">Part No: UY C</a>
                                        </h5>
                                        <span>Feature: 2 wire, filled connector with Polycarbonate body</span>
                                    </div>
                                </div>
                            </div>
                            <!--Blog Post End-->
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="event-post">
                                    ...
                                    <div class="event-txt">
                                        ...
                                        <span>Feature: 2 Wire, double contact and filled with sealant. Full compliance to British Telecom BTLN 363C specification</span>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="event-post">
                                    ...
                                    <div class="event-txt">
                                        <h5>
                                            <a href="#">Part No: UY2 P</a>
                                        </h5>
                                        <span> Feature: Full wire range, 2 wire, filled, Polypropylene connector.Best suited for general application.</span>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="event-post">
                                    ...
                                    <div class="event-txt">
                                        <h5>
                                            <a href="#">Part No: UY PD</a>
                                        </h5>
                                        <span>Feature: Dry version of UY2 P, for specific application (no sealant filling) </span>
                                    </div>
                                </div>
                            </div>
                            <!--Blog Post End--> 
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="event-post">
                                    ...
                                    <div class="event-txt">
                                        <h5>
                                            <a href="#">Part No: UR C</a>
                                        </h5>
                                        <span>Feature: A 3 wire, filled connector, for straight or bridge splicing, made of Polycarbonate</span>
                                    </div>
                                </div>
                            </div>
                            <!--Blog Post End-->
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="event-post">
                                    ...
                                    <div class="event-txt">
                                        <h5>
                                            <a href="#">Part No: UR2 P</a>
                                        </h5>
                                        <span>Feature:3 wire, filled, full wire range connector, made of Polypropylene, for straight or bridge splicing.</span>
                                    </div>
                                </div>
                            </div>
                            <!--Blog Post End-->
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="event-post">
                                    ...
                                    <div class="event-txt">
                                        <h5>
                                            <a href="#">Part No: UR2 PD</a>
                                        </h5>
                                        <span>Feature: Dry version of UR2 P, made of Polypropylene for pressurized joints or specific application.</span>
                                    </div>
                                </div>
                            </div>
                            <!--Blog Post End-->
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="event-post">
                                    ...
                                    <div class="event-txt">
                                        <h5>
                                            <a href="#">Part No: UR2 C</a>
                                        </h5>
                                        <span>Feature: A new version of UR2 P, filled connector, made of Polycarbonate, for special application needs</span>
                                    </div>
                                </div>
                            </div>
                            <!--Blog Post End-->
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="event-post">
                                    ...
                                    <div class="event-txt">
                                        <h5>
                                            <a href="#">Part No: UB D</a>
                                        </h5>
                                        <span>Feature: Tapping connector, with pre-crimp feature, for transfer without service interruption. Dry version.</span>
                                    </div>
                                </div>
                            </div>
                            <!--Blog Post End-->
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="event-post">
                                    ...
                                    <div class="event-txt">
                                        <h5>
                                            <a href="#">Part No: UB2 P</a>
                                        </h5>
                                        <span>Feature: Tapping connector,made of Polypropylene similar to UB C,for transfer without service interruption filled version.</span>
                                    </div>
                                </div>
                            </div>
                            <!--Blog Post End-->
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="event-post">
                                    ...
                                    <div class="event-txt">
                                        <h5>
                                            <a href="#">Part No: UB2 PD</a>
                                        </h5>
                                        <span>Feature: Tapping connector, made of Polypropylene similar to UB C,for transfer without service interruption. Dry version.</span>
                                    </div>
                                </div>
                            </div>
                            <!--Blog Post End-->
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="event-post">
                                    ...
                                    <div class="event-txt">
                                        <h5>
                                            <a href="#">Part No: UG C</a>
                                        </h5>
                                        <span>Feature: The UG C, made of Polycarbonate is a filled, tap connector, with double contact and accept larger cable diameters.</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="event-post">
                                    ...
                                    <div class="event-txt">
                                        <h5>
                                            <a href="#">Part No:UY4 CD</a>
                                        </h5>
                                        <span>Dry version of UY4 C, the connector is specifi cally made for non-pressurized joints with air core cables or for special applications.</span>
                                    </div>
                                </div>
                            </div>
                            <!--Blog Post End-->
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="event-post">
                                    ...
                                    <div class="event-txt">
                                        <h5>
                                            <a href="#">Part No:UD4 C1 Black</a>
                                        </h5>
                                        <span>Feature:In line full pair drop wire connectors, made from Polycarbonate using UV resistant material. Black colored connector for UV resistant.</span>
                                    </div>
                                </div>
                            </div>
                            <!--Blog Post End-->
