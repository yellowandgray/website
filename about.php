    ...
    <body class="subpage">
        ...
        <div class="bg-primary-3 o-hidden bg-position sub-banner" data-overlay  style='background: url(img/empower-bg.jpg)no-repeat; height:200px'>
            <section class="text-white pb-0">
                ...
                <div class="divider divider-custom-10 divider-bottom"></div>
            </section>
        </div>
...
<!--                            <tr>
        ...
        <section class="pt-0 o-hidden">
            ...
            <div class="divider transform-flip-x"></div>
        </section>
        <section class="bg-primary-3 ptb-80 text-white pt-0 about-project-next-door-section">
            <div class="divider divider-custom-14 transform-flip-x"></div>
            <div class="container">
                <div class="row justify-content-center text-center">
                    <div class="col-md-9 col-lg-8 col-xl-7">
...
<!--                        <img src="img/about/ttt.png" alt="" />-->
            ...
            <div class="divider divider-custom-16"></div>
        </section>
        ...
        <section class="pb-0">
            <div class="container">
                ...
                <!--                <div class="row justify-content-center text-center">
                                    <div class="col-sm-12 col-md-12 mb-12 mb-lg-0">
...
<!--        <section class="ptb-80 bg-light facilites">
            <div class="container">
                <div class="row section-title justify-content-center text-center">
                    <div class="col-md-12 col-lg-12 col-xl-12">
                        <h3 class="display-4">FACILITIES</h3>
                    </div>
                </div>
                <div class="row">
