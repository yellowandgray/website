                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="contact-form">
                                <form class="text-bg-1 wow fadeInUp starthere-form" style="width: 80%; margin: 0 auto;">
...
<!--                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" name="right_list[]" value="Have the financial resources to invest in transforming myself "> Have the financial resources to invest in transforming myself <br/>
                                        <input type="checkbox" name="right_list[]" value="Have access to the financial resources to invest in transforming myself. "> Have access to the financial resources to invest in transforming myself. <br/>
                                        <input type="checkbox" name="right_list[]" value="I do not have any financial resources at all and I am going to keep the state of my life exactly as it is. "> I do not have any financial resources at all and I am going to keep the state of my life exactly as it is.
                                    </div>
                                    <div class="form-group">
                                        <br/>
                                        <br/>
                                        <label>How would you like us to connect back with you to schedule your call/ meeting with Cheryl P Pinto</label><br/>
                                        <input type="checkbox" name="connect_list[]" value="Phone call"> Phone call <br/>
                                        <input type="checkbox" name="connect_list[]" value="WhatsApp "> WhatsApp <br/>
                                        <input type="checkbox" name="connect_list[]" value="Email "> Email<br/>
                                        <input type="checkbox" name="connect_list[]" value="Other (please specify) "> Other (please specify)<br/>
                                    </div>
                                    <div class="form-group">
                                        <br/>
