        ...
        <div id="wrapper">
            <section>
                <div id="mySignin" tabindex="-1" role="dialog" aria-labelledby="mySigninModalLabel" aria-hidden="true">
                    ...
                    <div class="login-modal modal styled">
...
<!--                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    <div class="controls">
                                        <button type="submit" class="btn">Sign in</button>  <a href="#myReset" data-dismiss="modal" aria-hidden="true" data-toggle="modal" class="float-right text-right">Forgot password?</a>
                                    </div>
