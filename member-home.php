                        ...
                        <div class="span6">
                            <div class="p-t-b-30px user-intro-content">
                                ...
                                <form class="subscription">
                                    <button class="submit" onClick="window.location.href='select_language';return false;">Start Quiz</button>
                                </form>
                                ...
                                <table class = 'table table-striped result_table' style="width:60%;">
                                              ...
                                              <tbody>
                                                    ...
                                                    foreach($stud_topic_order as $stud_topic) {
                                                        ...
                                                        echo $ques_year_cnt[$stud_topic]['subject_name']; ?></td>
                                                        <td><?php echo $ques_year_cnt[$stud_topic]['topic_name']; ?></td>
                                                        <td><?php if(isset($ques_year_cnt[$stud_topic]['count']))
                                                        {
